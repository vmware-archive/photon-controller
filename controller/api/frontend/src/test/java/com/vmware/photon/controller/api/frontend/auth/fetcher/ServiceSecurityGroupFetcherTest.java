...
/**
 * Tests {@link ServiceSecurityGroupFetcher}.
 */
public class ServiceSecurityGroupFetcherTest {

  private ServiceFeClient serviceFeClient;
  private ProjectSecurityGroupFetcher projectFetcher;

  private ServiceSecurityGroupFetcher fetcher;
  ...
  public class FetchSecurityGroupsTest {
    ...
    @BeforeMethod
    private void setUp() {
      serviceFeClient = mock(ServiceFeClient.class);
      projectFetcher = mock(ProjectSecurityGroupFetcher.class);
      fetcher = new ServiceSecurityGroupFetcher(serviceFeClient, projectFetcher);
    ...
    @Test(expectedExceptions = IllegalArgumentException.class,
        expectedExceptionsMessageRegExp = "authorizationObject must be of 'kind' SERVICE.")
    ...
    public void testInvalidId() throws Throwable {
      doThrow(new ServiceNotFoundException("id")).when(serviceFeClient).get("id");
    ...
    public void testParentWithoutSecurityGroups() throws Throwable {
      ...
      service.setProjectId("project-id");
      doReturn(service).when(serviceFeClient).get("id");
