...
/**
 * Tests {@link com.vmware.photon.controller.api.frontend.resources.tasks.ProjectTasksResource}.
 */
public class ProjectTasksResourceTest extends ResourceTest {
  ...
  protected void setUpResources() throws Exception {
    ...
    addResource(new ProjectTasksResource(client, paginationConfig));
  }
  ...
  public void testGetProjectTasks(Optional<Integer> pageSize,
    ...
    when(client.getProjectTasks(projectId, Optional.<String>absent(),
  ...
  private Response getTasks(String pageLink) {
    String uri = projectTasksRoutePath + "?pageLink=" + pageLink;
