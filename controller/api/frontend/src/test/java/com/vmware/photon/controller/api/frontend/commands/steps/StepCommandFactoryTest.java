...
import com.vmware.photon.controller.api.frontend.commands.tasks.TaskCommandTest;
...
public class StepCommandFactoryTest {
  ...
  public Object[][] getCreateCommandParams() {
    return new Object[][] {
        ...
        {Operation.GET_VM_IP, VmGetIpStepCmd.class},
        ...
        {Operation.PROVISION_SERVICES_MANAGER, DeploymentStatusStepCmd.class},
        ...
        // Service
        {Operation.CREATE_KUBERNETES_SERVICE_INITIATE, KubernetesServiceCreateStepCmd.class},
        {Operation.CREATE_KUBERNETES_SERVICE_SETUP_ETCD, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_KUBERNETES_SERVICE_SETUP_MASTER, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_KUBERNETES_SERVICE_UPDATE_EXTENDED_PROPERTIES, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_KUBERNETES_SERVICE_SETUP_WORKERS, XenonTaskStatusStepCmd.class},

        {Operation.CREATE_MESOS_SERVICE_INITIATE, MesosServiceCreateStepCmd.class},
        {Operation.CREATE_MESOS_SERVICE_SETUP_ZOOKEEPERS, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_MESOS_SERVICE_SETUP_MASTERS, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_MESOS_SERVICE_SETUP_MARATHON, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_MESOS_SERVICE_SETUP_WORKERS, XenonTaskStatusStepCmd.class},

        {Operation.CREATE_SWARM_SERVICE_INITIATE, SwarmServiceCreateStepCmd.class},
        {Operation.CREATE_SWARM_SERVICE_SETUP_ETCD, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_SWARM_SERVICE_SETUP_MASTER, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_SWARM_SERVICE_SETUP_WORKERS, XenonTaskStatusStepCmd.class},

        {Operation.CREATE_HARBOR_SERVICE_INITIATE, HarborServiceCreateStepCmd.class},
        {Operation.CREATE_HARBOR_SERVICE_SETUP_HARBOR, XenonTaskStatusStepCmd.class},
        {Operation.CREATE_HARBOR_SERVICE_UPDATE_EXTENDED_PROPERTIES, XenonTaskStatusStepCmd.class},

        {Operation.RESIZE_SERVICE_INITIATE, ServiceResizeStepCmd.class},
        {Operation.RESIZE_SERVICE_INITIALIZE_SERVICE, XenonTaskStatusStepCmd.class},
        {Operation.RESIZE_SERVICE_RESIZE, XenonTaskStatusStepCmd.class},

        {Operation.DELETE_SERVICE_INITIATE, ServiceDeleteStepCmd.class},
        {Operation.DELETE_SERVICE_UPDATE_SERVICE_DOCUMENT, XenonTaskStatusStepCmd.class},
        {Operation.DELETE_SERVICE_DELETE_VMS, XenonTaskStatusStepCmd.class},
        {Operation.DELETE_SERVICE_DOCUMENT, XenonTaskStatusStepCmd.class},
