...
/**
 * Tests {@link com.vmware.photon.controller.api.frontend.resources.tasks.TenantTasksResource}.
 */
public class TenantTasksResourceTest extends ResourceTest {
  ...
  public void testGetTenantTasks(Optional<Integer> pageSize,
    ...
    when(client.getTenantTasks(tenantId, Optional.<String>absent(), Optional.of(2)))
        .thenReturn(new ResourceList<>(ImmutableList.of(task1, task2), null, null));
    when(client.getTenantTasks(tenantId, Optional.<String>absent(), Optional.of(3)))
  ...
  @Test
  public void testGetTenantTasksPage() throws Exception {
  ...
  private Response getTasks(String pageLink) {
    String uri = tenantTasksRoute + "?pageLink=" + pageLink;
