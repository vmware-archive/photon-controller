...
/**
 * Tests for {@link com.vmware.photon.controller.api.frontend.resources.tasks.HostTasksResource}.
 */
public class HostTasksResourceTest extends ResourceTest {
  ...
  protected void setUpResources() {
    ...
    addResource(new HostTasksResource(client, paginationConfig));
  }
  ...
  public void testGetHostTasks(Optional<Integer> pageSize,
    ...
    when(client.getHostTasks(hostId, Optional.<String>absent(),
  ...
  @Test
  public void testGetHostTasksPage() throws Exception {
    task1.setId(taskId1);
    task2.setId(taskId2);
  ...
  private Response getTasks(String pageLink) {
    String uri = hostTaskRoute + "?pageLink=" + pageLink;
