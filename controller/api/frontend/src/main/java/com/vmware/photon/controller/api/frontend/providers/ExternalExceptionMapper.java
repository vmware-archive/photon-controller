...
import static com.vmware.photon.controller.api.frontend.Responses.externalException;
...
/**
 * Mapper for {@link ExternalException}.
 */
@Provider
public class ExternalExceptionMapper implements ExceptionMapper<ExternalException> {
  ...
  @Override
  public Response toResponse(ExternalException e) {
    logger.error("", e);
    return externalException(e);
  }
}
