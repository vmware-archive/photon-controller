...
import com.vmware.photon.controller.servicesmanager.servicedocuments.MesosServiceCreateTaskState.TaskState.SubStage;
...
/**
 * Polls Mesos service creation task status.
 */
public class MesosServiceCreateTaskStatusPoller implements XenonTaskStatusStepCmd.XenonTaskStatusPoller {
  private static final Map<Operation, Integer> OPERATION_TO_SUBSTAGE_MAP =
      ImmutableMap.<Operation, Integer>builder()
          .put(Operation.CREATE_MESOS_SERVICE_SETUP_ZOOKEEPERS, SubStage.SETUP_ZOOKEEPERS.ordinal())
          .put(Operation.CREATE_MESOS_SERVICE_SETUP_MASTERS, SubStage.SETUP_MASTERS.ordinal())
          .put(Operation.CREATE_MESOS_SERVICE_SETUP_MARATHON, SubStage.SETUP_MARATHON.ordinal())
          .put(Operation.CREATE_MESOS_SERVICE_SETUP_WORKERS, SubStage.SETUP_WORKERS.ordinal())
          .build();
  ...
  public MesosServiceCreateTaskStatusPoller(TaskCommand taskCommand, ServiceBackend serviceBackend,
  ...
  public TaskState poll(String remoteTaskLink)
    ...
    MesosServiceCreateTaskState serviceDocument =
        serviceBackend.getServicesManagerClient().getMesosServiceCreationStatus
        (remoteTaskLink);
  ...
  public int getSubStage(TaskState taskState) {
    return ((MesosServiceCreateTaskState.TaskState) taskState).subStage.ordinal();
  }
