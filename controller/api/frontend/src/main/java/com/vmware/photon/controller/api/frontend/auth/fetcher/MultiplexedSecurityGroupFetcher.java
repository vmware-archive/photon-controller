...
public class MultiplexedSecurityGroupFetcher implements SecurityGroupFetcher {
  ...
  public MultiplexedSecurityGroupFetcher(
    ...
    this.fetcherMap.put(TransactionAuthorizationObject.Kind.SERVICE, serviceFetcher);
    this.fetcherMap.put(TransactionAuthorizationObject.Kind.SERVICE, clusterFetcher);
