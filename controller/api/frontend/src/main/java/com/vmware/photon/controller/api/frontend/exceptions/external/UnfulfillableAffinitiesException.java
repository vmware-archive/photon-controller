 ...
 */
public class UnfulfillableAffinitiesException extends ExternalException {

  public UnfulfillableAffinitiesException() {
    super(ErrorCode.UNFULLFILLABLE_AFFINITIES);
  }
