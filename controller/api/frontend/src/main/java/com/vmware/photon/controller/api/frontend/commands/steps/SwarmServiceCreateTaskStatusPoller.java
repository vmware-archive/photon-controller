...
import com.vmware.photon.controller.servicesmanager.servicedocuments.SwarmServiceCreateTaskState.TaskState.SubStage;
...
/**
 * Polls Swarm service creation task status.
 */
public class SwarmServiceCreateTaskStatusPoller implements XenonTaskStatusStepCmd.XenonTaskStatusPoller {
  private static final Map<Operation, Integer> OPERATION_TO_SUBSTAGE_MAP =
      ImmutableMap.<Operation, Integer>builder()
          .put(Operation.CREATE_SWARM_SERVICE_SETUP_ETCD, SubStage.SETUP_ETCD.ordinal())
          .put(Operation.CREATE_SWARM_SERVICE_SETUP_MASTER, SubStage.SETUP_MASTER.ordinal())
          .put(Operation.CREATE_SWARM_SERVICE_SETUP_WORKERS, SubStage.SETUP_WORKERS.ordinal())
          .build();
  ...
  public SwarmServiceCreateTaskStatusPoller(TaskCommand taskCommand, ServiceBackend serviceBackend,
  ...
  public TaskState poll(String remoteTaskLink) throws DocumentNotFoundException, TaskNotFoundException {
    SwarmServiceCreateTaskState serviceDocument = serviceBackend.getServicesManagerClient()
        .getSwarmServiceCreationStatus(remoteTaskLink);
  ...
  public int getSubStage(TaskState taskState) {
    return ((SwarmServiceCreateTaskState.TaskState) taskState).subStage.ordinal();
  }
