...
public enum ErrorCode {
  ...
  SERVICE_NOT_FOUND("ServiceNotFound", Response.Status.NOT_FOUND),
  SECURITY_GROUPS_ALREADY_INHERITED("SecurityGroupsAlreadyInherited", Response.Status.BAD_REQUEST),
  SERVICE_TYPE_ALREADY_CONFIGURED("ServiceTypeAlreadyConfigured", Response.Status.BAD_REQUEST),
  SERVICE_TYPE_NOT_CONFIGURED("ServiceTypeNotConfigured", Response.Status.NOT_FOUND),
