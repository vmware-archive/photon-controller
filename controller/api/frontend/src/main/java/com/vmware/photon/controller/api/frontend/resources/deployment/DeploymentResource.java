...
public class DeploymentResource {
  ...
  @POST
  @Path(DeploymentResourceRoutes.CONFIGURE_NSX_ACTION)
  @ApiOperation(value = "Configure NSX associated with the Deployment", response = Task.class)
  @ApiResponses(value = {
      @ApiResponse(code = 201, message = "Task created, NSX configuration progress can be queried " +
          "via the task")
  })
