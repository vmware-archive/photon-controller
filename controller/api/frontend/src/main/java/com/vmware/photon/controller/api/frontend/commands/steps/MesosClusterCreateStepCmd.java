...
/**
 * StepCommand that kicks off Mesos cluster creation.
 */
public class MesosClusterCreateStepCmd extends StepCommand {
  private static final Logger logger = LoggerFactory.getLogger(MesosClusterCreateStepCmd.class);
  ...
  public MesosClusterCreateStepCmd(TaskCommand taskCommand, StepBackend stepBackend,
  ...
  protected void execute() throws SpecInvalidException {
    ...
    MesosClusterCreateTask serviceDocument = clusterBackend.getClusterManagerClient()
        .createMesosCluster(projectId, spec);
