...
/**
 * StepCommand that kicks off Swarm service creation.
 */
public class SwarmServiceCreateStepCmd extends StepCommand {
  private static final Logger logger = LoggerFactory.getLogger(SwarmServiceCreateStepCmd.class);
  ...
  public SwarmServiceCreateStepCmd(TaskCommand taskCommand, StepBackend stepBackend,
  ...
  protected void execute() throws SpecInvalidException {
    ...
    logger.info("SwarmServiceCreateStepCmd started, projectId={}, serviceName={}", projectId, spec.getName());

    SwarmServiceCreateTaskState serviceDocument = serviceBackend.getServicesManagerClient()
        .createSwarmService(projectId, spec);
    ...
    logger.info("Service creation initiated: id={}", serviceDocument.documentSelfLink);
  }
