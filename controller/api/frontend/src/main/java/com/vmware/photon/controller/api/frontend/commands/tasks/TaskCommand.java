...
import com.vmware.photon.controller.api.frontend.commands.BaseCommand;
...
import com.vmware.photon.controller.api.frontend.exceptions.external.TaskNotCompletedException;
...
public class TaskCommand extends BaseCommand {
  ...
  public com.vmware.photon.controller.api.frontend.backends.clients.HousekeeperClient getHousekeeperXenonClient() {
