...
/**
 * Service resize operation is requested via POST to /services/{id}/resize. The payload of the POST is the
 * ServiceResizeOperation object.
 */
@ApiModel(value = "Service resize operation")
@JsonIgnoreProperties(ignoreUnknown = true)
public class ServiceResizeOperation {
  ...
  public boolean equals(Object o) {
    ...
    ServiceResizeOperation other = (ServiceResizeOperation) o;
