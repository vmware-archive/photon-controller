...
import com.vmware.photon.controller.api.model.builders.DiskCreateSpecBuilder;
  ...
  public class ValidationTest {
    ...
    private Object[][] getInvalidDiskCreateSpecs() {
      ...
      return new Object[][]{
          ...
          // flavor
          {new DiskCreateSpecBuilder().name("d").kind("persistent").flavor(null).capacityGb(2).build(),
              "flavor may not be null (was null)"},
