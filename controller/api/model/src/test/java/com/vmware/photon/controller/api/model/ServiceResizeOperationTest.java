...
/**
 * Tests {@link ServiceResizeOperation}.
 */
public class ServiceResizeOperationTest {
  private Validator validator = new Validator();
  private ServiceResizeOperation operation;
  ...
  private ServiceResizeOperation createValidResizeOperation() {
    ServiceResizeOperation s = new ServiceResizeOperation();
    s.setNewWorkerCount(50);
    return s;
  }

  /**
   * Tests for {@link ServiceResizeOperation#newWorkerCount}.
   */
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      ...
      String json = jsonFixture("fixtures/service-resize-operation.json");
      assertThat(asJson(operation), is(equalTo(json)));
      assertThat(fromJson(json, ServiceResizeOperation.class), is(operation));
    }
  }

  /**
   * Tests for {@link ServiceResizeOperation#toString()}.
   */
  public class ToStringTest {
    ...
    public void testToString() {
      String expectedString = "ServiceResizeOperation{newWorkerCount=50}";
