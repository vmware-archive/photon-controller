...
/**
 * Tests {@link ServiceCreateSpec}.
 */
public class ServiceCreateSpecTest {
  private Validator validator = new Validator();
  private ServiceCreateSpec spec;
  ...
  private ServiceCreateSpec createValidSpec() {
  ...
  /**
   * Tests for {@link ServiceCreateSpec#vmFlavor}.
   */
  ...
  /**
   * Tests for {@link ServiceCreateSpec#diskFlavor}.
   */
  ...
  /**
   * Tests for {@link ServiceCreateSpec#workerCount}.
   */
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      ...
      String json = JsonHelpers.jsonFixture("fixtures/service-create-spec.json");
      MatcherAssert.assertThat(JsonHelpers.asJson(spec), is(equalTo(json)));
      MatcherAssert.assertThat(JsonHelpers.fromJson(json, ServiceCreateSpec.class), is(spec));
    }
  }

  /**
   * Tests for {@link ServiceCreateSpec#toString()}.
   */
  public class ToStringTest {
    ...
    public void testToString() {
      String expectedString = "ServiceCreateSpec{name=serviceName, type=KUBERNETES," +
