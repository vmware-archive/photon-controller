  ...
  public class ToStringTest {
    ...
    public void testCorrectString() {
      String expectedString =
          "Deployment{id=id, " +
          "Kind=deployment, " +
          "imageDatastores=image-datastore1,image-datastore2, " +
          "syslogEndpoint=0.0.0.1, " +
          "stats=StatsInfo{enabled=true, storeEndpoint=10.146.64.111, storePort=2004, storeType=GRAPHITE}, " +
          "ntpEndpoint=0.0.0.2, " +
          "useImageDatastoreForVms=false, " +
          "auth=AuthInfo{enabled=true, " +
              "endpoint=10.146.64.236, " +
              "port=443, " +
              "tenant=t, " +
              "securityGroups=adminGroup1,adminGroup2}, " +
          "networkConfiguration=NetworkConfiguration{sdnEnabled=true, " +
              "networkManagerAddress=1.2.3.4, " +
              "networkZoneId=networkZoneId, " +
              "networkTopRouterId=networkTopRouterId, " +
              "networkEdgeIpPoolId=networkEdgeIpPoolId, " +
              ...
              "networkDhcpRelayId=networkDhcpRelayId, " +
              "ipRange=10.0.0.1/24, " +
              "floatingIpRange=IpRange{start=192.168.0.2, end=192.168.0.254}, " +
              "edgeClusterId=edgeClusterId, " +
              "dhcpServers=192.10.0.1,192.20.0.1}, " +
          "loadBalancerEnabled=true, " +
          "loadBalancerAddress=0.0.0.4, " +
