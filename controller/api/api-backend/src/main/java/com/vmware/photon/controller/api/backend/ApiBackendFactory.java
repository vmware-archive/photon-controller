...
package com.vmware.photon.controller.api.backend;

import com.vmware.photon.controller.api.backend.tasks.ConfigureRoutingTaskService;
import com.vmware.photon.controller.api.backend.tasks.ConnectVmToSwitchTaskService;
import com.vmware.photon.controller.api.backend.tasks.CreateLogicalRouterTaskService;
import com.vmware.photon.controller.api.backend.tasks.CreateLogicalSwitchTaskService;
...
public class ApiBackendFactory {
  ...
  public static final Map<Class<? extends Service>, Supplier<FactoryService>> FACTORY_SERVICES_MAP =
      ...
      .put(ConfigureNsxWorkflowService.class, ConfigureNsxWorkflowService::createFactory)
