...
import com.vmware.photon.controller.api.backend.servicedocuments.ConnectVmToSwitchTask;
import com.vmware.photon.controller.api.backend.servicedocuments.DisconnectVmFromSwitchTask;
import com.vmware.photon.controller.api.backend.servicedocuments.DisconnectVmFromSwitchTask.TaskState;
...
public class DisconnectVmFromSwitchTaskService extends StatefulService {
  ...
  public void handleStart(Operation startOperation) {
    ...
    try {
      ...
      if (startState.taskState.stage == DisconnectVmFromSwitchTask.TaskState.TaskStage.CREATED) {
        startState.taskState.stage = DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED;
        startState.taskState.subStage = DisconnectVmFromSwitchTask.TaskState.SubStage.GET_NSX_CONFIGURATION;
      }
      ...
      } else if (DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED == startState.taskState.stage) {
  ...
  public void handlePatch(Operation patchOperation) {
    ...
    try {
      ...
      } else if (DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED == currentState.taskState.stage) {
        ...
        .setCompletion((op, ex) -> {
          ...
          try {
            ...
            DisconnectVmFromSwitchTask patchState = buildPatch(
                DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED,
                DisconnectVmFromSwitchTask.TaskState.SubStage.GET_VIRTUAL_NETWORK);
    ...
    try {
      ...
      logicalSwitchApi.deleteLogicalPort(toVmPortId, new FutureCallback<Void>() {
        ...
        public void onSuccess(@Nullable Void result) {
          DisconnectVmFromSwitchTask patch = buildPatch(DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED,
              DisconnectVmFromSwitchTask.TaskState.SubStage.UPDATE_VIRTUAL_NETWORK);
          TaskUtils.sendSelfPatch(DisconnectVmFromSwitchTaskService.this, patch);
        }
  ...
  private void updateVirtualNetwork(DisconnectVmFromSwitchTask currentState) {
    ...
    ServiceHostUtils.getCloudStoreHelper(getHost())
        ...
        .setCompletion((op, ex) -> {
          ...
          try {
            DisconnectVmFromSwitchTask patch = buildPatch(DisconnectVmFromSwitchTask.TaskState.TaskStage.FINISHED);
            TaskUtils.sendSelfPatch(DisconnectVmFromSwitchTaskService.this, patch);
          } catch (Throwable t) {
            failTask(t);
          }
  ...
  private void validateTaskSubStageProgression(TaskState startState, TaskState patchState) {
    ...
    if (patchState.stage == DisconnectVmFromSwitchTask.TaskState.TaskStage.FINISHED) {
      checkState(startState.subStage == DisconnectVmFromSwitchTask.TaskState.SubStage.UPDATE_VIRTUAL_NETWORK);
    } else if (patchState.stage == DisconnectVmFromSwitchTask.TaskState.TaskStage.STARTED) {
