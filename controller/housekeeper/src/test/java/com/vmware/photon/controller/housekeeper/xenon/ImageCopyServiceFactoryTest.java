...
/**
 * Tests {@link ImageCopyServiceFactory}.
 */
public class ImageCopyServiceFactoryTest {

  private ImageCopyServiceFactory factory;
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      factory = new ImageCopyServiceFactory();
    }
  ...
  public class CreateServiceInstanceTest {
    ...
    void testSuccess() throws Throwable {
      ...
      assertThat(service, instanceOf(ImageCopyService.class));
    }
  }
}
