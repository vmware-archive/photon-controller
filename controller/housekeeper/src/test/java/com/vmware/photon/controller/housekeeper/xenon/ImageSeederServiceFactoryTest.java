...
/**
 * Tests {@link com.vmware.photon.controller.housekeeper.xenon.ImageReplicatorServiceFactory}.
 */
public class ImageSeederServiceFactoryTest {

  private ImageSeederServiceFactory factory;

  @BeforeMethod
  public void setUp() throws Throwable {
    factory = new ImageSeederServiceFactory();
  }
  ...
  public void testCreateServiceInstance() throws Throwable {
    ...
    assertThat(service, instanceOf(ImageSeederService.class));
  }
}
