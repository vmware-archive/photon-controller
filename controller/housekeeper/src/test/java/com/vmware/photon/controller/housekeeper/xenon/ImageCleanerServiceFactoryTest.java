...
/**
 * Tests {@link ImageCleanerServiceFactory}.
 */
public class ImageCleanerServiceFactoryTest {

  private ImageCleanerServiceFactory factory;
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      factory = new ImageCleanerServiceFactory();
    }
  ...
  public class CreateServiceInstanceTest {
    ...
    void testSuccess() throws Throwable {
      ...
      assertThat(service, instanceOf(ImageCleanerService.class));
    }
  }
}
