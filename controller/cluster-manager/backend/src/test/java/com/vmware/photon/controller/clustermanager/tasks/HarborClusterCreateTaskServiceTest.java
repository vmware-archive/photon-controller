...
import com.vmware.photon.controller.clustermanager.statuschecks.HarborStatusChecker;
...
/**
 * This class implements tests for the {@link HarborClusterCreateTaskService} class.
 */
public class HarborClusterCreateTaskServiceTest {

  private TestHost host;
  private HarborClusterCreateTaskService taskService;
  ...
  private HarborClusterCreateTask buildValidStartState(
      TaskState.TaskStage stage, HarborClusterCreateTask.TaskState.SubStage subStage) throws Throwable {

    HarborClusterCreateTask state = ReflectionUtils.buildValidStartState(HarborClusterCreateTask.class);
  ...
  private HarborClusterCreateTask buildValidPatchState(
      TaskState.TaskStage stage, HarborClusterCreateTask.TaskState.SubStage subStage) {

    HarborClusterCreateTask patchState = new HarborClusterCreateTask();
    patchState.taskState = new HarborClusterCreateTask.TaskState();
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      taskService = new HarborClusterCreateTaskService();
    }
  ...
  public class HandleStartTest {
    ...
    public void testValidStartState(TaskState.TaskStage stage,
                                    HarborClusterCreateTask.TaskState.SubStage subStage) throws Throwable {

      HarborClusterCreateTask startState = buildValidStartState(stage, subStage);

      Operation startOp = host.startServiceSynchronously(taskService, startState);
      assertThat(startOp.getStatusCode(), is(200));
      HarborClusterCreateTask savedState = host.getServiceState(
          HarborClusterCreateTask.class);
    ...
    public Object[][] getValidStartStates() {
      ...
      return new Object[][]{
          ...
          {TaskState.TaskStage.STARTED,
              HarborClusterCreateTask.TaskState.SubStage.SETUP_HARBOR},
    ...
    public void testMissingStateValue(String attributeName) throws Throwable {
      HarborClusterCreateTask startState = buildValidStartState(null, null);
    ...
    public Object[][] getAttributeNames() {
      List<String> notNullAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          HarborClusterCreateTask.class, NotNull.class);
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageUpdates(TaskState.TaskStage startStage,
                                      HarborClusterCreateTask.TaskState.SubStage startSubStage,
                                      TaskState.TaskStage patchStage,
                                      HarborClusterCreateTask.TaskState.SubStage patchSubStage) throws Throwable {

      HarborClusterCreateTask startState = buildValidStartState(startStage, startSubStage);
      host.startServiceSynchronously(taskService, startState);

      HarborClusterCreateTask patchState = buildValidPatchState(patchStage, patchSubStage);
      ...
      HarborClusterCreateTask savedState = host.getServiceState(HarborClusterCreateTask.class);
    ...
    public Object[][] getValidStageUpdates()
      ...
      return new Object[][]{
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.STARTED, HarborClusterCreateTask.TaskState.SubStage.SETUP_HARBOR},
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.FAILED, null},
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.CANCELLED, null},
    ...
    public void testInvalidSubStageUpdates(TaskState.TaskStage startStage,
                                           HarborClusterCreateTask.TaskState.SubStage startSubStage,
                                           TaskState.TaskStage patchStage,
                                           HarborClusterCreateTask.TaskState.SubStage patchSubStage)
        throws Throwable {
    ...
    public void testInvalidPatchImmutableFieldChanged(String fieldName) throws Throwable {
      HarborClusterCreateTask startState = buildValidStartState(TaskState.TaskStage.CREATED, null);
      Operation startOperation = host.startServiceSynchronously(taskService, startState);
      assertThat(startOperation.getStatusCode(), is(200));

      HarborClusterCreateTask patchState = buildValidPatchState(TaskState.TaskStage.STARTED,
          HarborClusterCreateTask.TaskState.SubStage.SETUP_HARBOR);
    ...
    public Object[][] getImmutableFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              HarborClusterCreateTask.class, Immutable.class));
    }
  }

  /**
   * End-to-end tests for the Harbor cluster create task.
   */
  public class EndToEndTest {
    ...
    private HarborClusterCreateTask startState;
    ...
    public void testEndToEndSuccess(int clusterSize, ClusterState expectedState) throws Throwable {
      ...
      HarborClusterCreateTask savedState = machine.callServiceAndWaitForState(
          HarborClusterCreateTaskFactoryService.SELF_LINK,
          startState,
          HarborClusterCreateTask.class,
    ...
    private void createClusterEntity(int size) throws Throwable {
      ...
      cluster.clusterName = "harborCluster";
      cluster.clusterType = ClusterType.HARBOR;
