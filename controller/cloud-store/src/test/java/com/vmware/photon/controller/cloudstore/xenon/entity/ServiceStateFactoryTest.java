...
/**
 * Tests {@link ServiceStateFactory}.
 */
public class ServiceStateFactoryTest {

  private ServiceStateFactory factory;

  @BeforeMethod
  public void setUp() throws Throwable {
    factory = new ServiceStateFactory();
  }
  ...
  public void testCreateServiceInstance() throws Throwable {
    ...
    assertThat(service, instanceOf(ServiceState.class));
  }
}
