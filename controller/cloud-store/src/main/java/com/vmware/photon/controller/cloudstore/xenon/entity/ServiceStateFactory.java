 ...
 * {@link ServiceState} instances.
 */
public class ServiceStateFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.CLOUDSTORE_ROOT + "/services";

  public ServiceStateFactory() {
    super(ServiceState.State.class);
