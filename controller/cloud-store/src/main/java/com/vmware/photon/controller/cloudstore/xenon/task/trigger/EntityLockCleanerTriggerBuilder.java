...
import com.vmware.photon.controller.cloudstore.xenon.task.EntityLockCleanerService;
...
public class EntityLockCleanerTriggerBuilder implements TaskStateBuilder {
  ...
  public TaskTriggerService.State build() {
    ...
    state.serializedTriggerState = Utils.toJson(false, false, new EntityLockCleanerService.State());
