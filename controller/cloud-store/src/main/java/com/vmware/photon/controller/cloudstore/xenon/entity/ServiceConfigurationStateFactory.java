 ...
 * {@link ServiceConfigurationState} instances.
 */
public class ServiceConfigurationStateFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.CLOUDSTORE_ROOT + "/service-configurations";

  public ServiceConfigurationStateFactory() {
    super(ServiceConfigurationState.State.class);
    super.setPeerNodeSelectorPath(ServiceUriPaths.DEFAULT_CLOUD_STORE_NODE_SELECTOR);
  }

  @Override
  public Service createServiceInstance() throws Throwable {
    return new ServiceConfigurationState();
  }
