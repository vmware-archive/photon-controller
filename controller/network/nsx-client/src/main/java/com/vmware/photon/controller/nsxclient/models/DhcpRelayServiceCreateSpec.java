...
/**
 * This class represents a DhcpRelayServiceCreateSpec JSON structure.
 */
@JsonIgnoreProperties(ignoreUnknown =  true)
public class DhcpRelayServiceCreateSpec {
  ...
  public boolean equals(Object o) {
    ...
    DhcpRelayServiceCreateSpec other = (DhcpRelayServiceCreateSpec) o;
