...
/**
 * Represent a port on tier0 router that connects to tier1 router.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class LogicalRouterLinkPortOnTier0 {
  ...
  public boolean equals(Object o) {
    ...
    LogicalRouterLinkPortOnTier0 other = (LogicalRouterLinkPortOnTier0) o;
