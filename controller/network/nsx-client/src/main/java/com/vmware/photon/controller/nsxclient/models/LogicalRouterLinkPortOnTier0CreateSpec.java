...
/**
 * Spec for creating a link port on tier0 router to connect to tier1 router.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class LogicalRouterLinkPortOnTier0CreateSpec {
  ...
  public void setLinkedLogicalRouterPortId(String linkedLogicalRouterPortId) {
  ...
  public boolean equals(Object o) {
    ...
    LogicalRouterLinkPortOnTier0CreateSpec other = (LogicalRouterLinkPortOnTier0CreateSpec) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), description, displayName, id, linkedLogicalRouterPortId, logicalRouterId,
        macAddress, resourceType, serviceBindings, subnets, tags);
  }
