...
/**
 * Spec for creating a link port on tier1 router to connect to tier0 router.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class LogicalRouterLinkPortOnTier1CreateSpec {
  ...
  @JsonProperty(value = "edge_cluster_member_index", required = false)
  ...
  @JsonProperty(value = "subnets", required = false)
  @Size(min = 1, max = 1)
  ...
  public List<Integer> getEdgeClusterMemberIndex() {
    return edgeClusterMemberIndex;
  }

  public void setEdgeClusterMemberIndex(List<Integer> edgeClusterMemberIndex) {
  ...
  public boolean equals(Object o) {
    ...
    LogicalRouterLinkPortOnTier1CreateSpec other = (LogicalRouterLinkPortOnTier1CreateSpec) o;
    return Objects.equals(this.description, other.description)
        && Objects.equals(this.displayName, other.displayName)
        && Objects.equals(this.edgeClusterMemberIndex, other.edgeClusterMemberIndex)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), description, displayName, edgeClusterMemberIndex, id,
        linkedLogicalRouterPortId, logicalRouterId, macAddress, resourceType, serviceBindings, subnets, tags);
  }
