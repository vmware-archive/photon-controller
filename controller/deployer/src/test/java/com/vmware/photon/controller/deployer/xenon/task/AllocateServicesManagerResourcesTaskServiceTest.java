...
/**
 * This class implements tests for {@link AllocateServicesManagerResourcesTaskServiceTest} class.
 */
public class AllocateServicesManagerResourcesTaskServiceTest {

  private TestHost host;
  private AllocateServicesManagerResourcesTaskService service;
  ...
  private AllocateServicesManagerResourcesTaskService.State buildValidStartupState() throws Throwable {
    return buildValidStartupState(TaskState.TaskStage.CREATED, null);
  }

  private AllocateServicesManagerResourcesTaskService.State buildValidStartupState(
      TaskState.TaskStage stage,
      AllocateServicesManagerResourcesTaskService.TaskState.SubStage subStage) throws Throwable {
    AllocateServicesManagerResourcesTaskService.State state = ReflectionUtils.buildValidStartState(
  ...
  private AllocateServicesManagerResourcesTaskService.State buildValidPatchState(
      TaskState.TaskStage stage,
      AllocateServicesManagerResourcesTaskService.TaskState.SubStage subStage) {
    AllocateServicesManagerResourcesTaskService.State state = new AllocateServicesManagerResourcesTaskService.State();
    state.taskState = new AllocateServicesManagerResourcesTaskService.TaskState();
    state.taskState.stage = stage;
    state.taskState.subStage = subStage;
    return state;
  }
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      service = new AllocateServicesManagerResourcesTaskService();
    }
  ...
  public class HandleStartTest {
    ...
    public void testMinimalStartState(
      ...
      AllocateServicesManagerResourcesTaskService.State startState = buildValidStartupState(stage, subStage);
      Operation startOp = host.startServiceSynchronously(service, startState);
      assertThat(startOp.getStatusCode(), is(200));

      AllocateServicesManagerResourcesTaskService.State savedState = host.getServiceState(
          AllocateServicesManagerResourcesTaskService.State.class);
    ...
    public Object[][] getValidStartStates() {
      ...
      return new Object[][]{
          ...
          {TaskState.TaskStage.STARTED,
              AllocateServicesManagerResourcesTaskService.TaskState.SubStage.GET_LOAD_BALANCER_ADDRESS},
          {TaskState.TaskStage.STARTED,
              AllocateServicesManagerResourcesTaskService.TaskState.SubStage.CREATE_MASTER_VM_FLAVOR},
          {TaskState.TaskStage.STARTED,
              AllocateServicesManagerResourcesTaskService.TaskState.SubStage.CREATE_OTHER_VM_FLAVOR},
          {TaskState.TaskStage.STARTED,
              AllocateServicesManagerResourcesTaskService.TaskState.SubStage.CREATE_VM_DISK_FLAVOR},
    ...
    public void testMissingStateValue(String attributeName) throws Throwable {
      AllocateServicesManagerResourcesTaskService.State startState = ReflectionUtils.buildValidStartState(
          AllocateServicesManagerResourcesTaskService.State.class);
    ...
    public Object[][] getAttributeNames() {
      List<String> notNullAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          AllocateServicesManagerResourcesTaskService.State.class, NotNull.class);
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageUpdates(
        ...
        AllocateServicesManagerResourcesTaskService.TaskState.SubStage startSubStage,
        TaskState.TaskStage targetStage,
        AllocateServicesManagerResourcesTaskService.TaskState.SubStage targetSubStage)
        throws Throwable {

      AllocateServicesManagerResourcesTaskService.State startState = buildValidStartupState(startStage, startSubStage);
      host.startServiceSynchronously(service, startState);

      AllocateServicesManagerResourcesTaskService.State patchState = buildValidPatchState(targetStage, targetSubStage);
      ...
      AllocateServicesManagerResourcesTaskService.State savedState =
          host.getServiceState(AllocateServicesManagerResourcesTaskService.State.class);
    ...
    public void testInvalidPatchStateValue(String attributeName) throws Throwable {
      AllocateServicesManagerResourcesTaskService.State startState = buildValidStartupState(
          TaskState.TaskStage.CREATED, null);
      Operation startOperation = host.startServiceSynchronously(service, startState);
      assertThat(startOperation.getStatusCode(), is(200));

      AllocateServicesManagerResourcesTaskService.State patchState = buildValidPatchState(
          TaskState.TaskStage.STARTED,
          AllocateServicesManagerResourcesTaskService.TaskState.SubStage.CREATE_MASTER_VM_FLAVOR);
    ...
    public Object[][] getAttributeNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              AllocateServicesManagerResourcesTaskService.State.class, Immutable.class));
    }
  }
  ...
  public class EndToEndTest {
    ...
    private AllocateServicesManagerResourcesTaskService.State startState;
    ...
    public void testEndToEndSuccess() throws Throwable {
      ...
      AllocateServicesManagerResourcesTaskService.State finalState =
