  ...
  public class EndToEndTest {
    ...
    public void setUpClass() throws Throwable {
      ...
      implicitClient = new AuthClientHandler.ImplicitClient("client",
          "https://10.0.0.0/pc?scope=a&response_type=b&correlation_id=c&state=l&nonce=m" +
              "&redirect_uri=https://0.0.0.0/callback.hmtl",
          "https://10.0.0.0/pc?id_token_hint=a&correlation_id=b&state=c&nonce=d" +
              "&redirect_uri=https://0.0.0.0/callback.html");
    }
