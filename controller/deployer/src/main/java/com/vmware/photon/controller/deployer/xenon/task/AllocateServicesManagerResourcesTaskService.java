...
/**
 * Implements a Xenon workflow service to allocate Service Manager resources.
 */
public class AllocateServicesManagerResourcesTaskService extends StatefulService {

  /**
   * This class defines the state of a {@link AllocateServicesManagerResourcesTaskService} task.
   */
   ...
   * {@link AllocateServicesManagerResourcesTaskService} service.
   */
  ...
  public AllocateServicesManagerResourcesTaskService() {
    super(State.class);
  ...
  private void queryForLoadBalancerContainerTemplate(final State currentState) {
    // The uploading of the kubernetes service image file happens after
    ...
    // service image, which in turn uploads the image via APIFE on the
    // management plane.
    ...
    Operation queryPostOperation = Operation
        ...
        .setCompletion((Operation operation, Throwable throwable) -> {
          ...
          try {
            ...
            QueryTaskUtils.logQueryResults(AllocateServicesManagerResourcesTaskService.this, documentLinks);
    ...
    Operation getOperation = Operation
        ...
        .setCompletion((Operation operation, Throwable throwable) -> {
          ...
          try {
            ...
            TaskUtils.sendSelfPatch(AllocateServicesManagerResourcesTaskService.this, patchState);
          } catch (Throwable t) {
            failTask(t);
          }
        });
  ...
  private FlavorCreateSpec createMasterVmFlavor() throws Throwable {
    ...
    spec.setName(ServicesManagerConstants.MASTER_VM_FLAVOR);
    spec.setKind("vm");
