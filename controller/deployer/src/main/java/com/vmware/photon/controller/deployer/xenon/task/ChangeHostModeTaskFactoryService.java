...
public class ChangeHostModeTaskFactoryService extends FactoryService {
  ...
  public static final String SELF_LINK = ServiceUriPaths.SERVICES_ROOT + "/change-host-mode-tasks";

  public ChangeHostModeTaskFactoryService() {
    super(ChangeHostModeTaskService.State.class);
  }

  public Service createServiceInstance() {
    return new ChangeHostModeTaskService();
  }
}
