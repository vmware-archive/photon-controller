 ...
 * SwarmServiceCreateTaskState instance.
 */
@NoMigrationDuringUpgrade
@NoMigrationDuringDeployment
public class SwarmServiceCreateTaskState extends ServiceDocument {
  ...
  /**
   * Identifier that will be used to create the Swarm service.
   */
  @DefaultUuid
  @Immutable
  ...
  /**
   * This class defines the state of a SwarmServiceCreateTaskService task.
   */
