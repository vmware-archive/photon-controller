...
package com.vmware.photon.controller.servicesmanager.servicedocuments;

import java.util.concurrent.TimeUnit;

/**
 * This class defines constant values for services manager.
 */
public class ServicesManagerConstants {
  ...
  public static final String EXTENDED_PROPERTY_SERVICE_VERSION          = "service_version";
  public static final String EXTENDED_PROPERTY_SERVICE_UI_URL           = "service_ui_url";
  ...
  /**
   * This class defines constant values for Kubernetes service.
   */
  ...
  /**
   * This class defines constant values for Mesos service.
   */
  ...
  /**
   * This class defines constant values for Swarm service.
   */
  ...
  /**
   * This class defines constant values for Harbor service.
   */
