 ...
 * KubernetesServiceCreateTaskService instance.
 */
@NoMigrationDuringUpgrade
@NoMigrationDuringDeployment
public class KubernetesServiceCreateTaskState extends ServiceDocument {
  ...
  /**
   * Identifier that will be used to create the Kubernetes service.
   */
  @DefaultUuid
  @Immutable
  ...
  /**
   * This class defines the state of a KubernetesServiceCreateTaskService task.
   */
