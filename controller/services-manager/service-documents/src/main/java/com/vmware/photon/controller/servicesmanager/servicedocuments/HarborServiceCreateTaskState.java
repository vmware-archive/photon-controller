 ...
 * HarborServiceCreateTaskService instance.
 */
@NoMigrationDuringUpgrade
@NoMigrationDuringDeployment
public class HarborServiceCreateTaskState extends ServiceDocument {
  ...
  /**
   * Identifier that will be used to create the Harbor service.
   */
  @DefaultUuid
  @Immutable
  ...
  public Integer updatePropsIterations;
  ...
  @Positive
  @Immutable
  public Integer updatePropsMaxIterations;
  ...
  @Positive
  @Immutable
  public Integer updatePropsPollDelay;


  /**
   * This class defines the state of a HarborServiceCreateTaskService task.
   */
