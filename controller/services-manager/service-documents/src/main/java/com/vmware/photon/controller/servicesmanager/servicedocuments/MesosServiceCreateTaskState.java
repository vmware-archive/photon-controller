 ...
 * MesosServiceCreateTaskService instance.
 */
@NoMigrationDuringUpgrade
@NoMigrationDuringDeployment
public class MesosServiceCreateTaskState extends ServiceDocument {
  ...
  /**
   * Identifier that will be used to create the Mesos service.
   */
  @DefaultUuid
  @Immutable
  ...
  /**
   * This class defines the state of a MesosServiceCreateTaskService task.
   */
