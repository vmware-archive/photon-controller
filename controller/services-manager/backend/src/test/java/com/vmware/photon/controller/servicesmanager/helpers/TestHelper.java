...
public class TestHelper {
  ...
  public static void createSuccessScriptFile(File scriptDirectory, String fileName) throws IOException {
    createScriptFile(scriptDirectory, "exit 0\n", fileName);
  }

  public static void createFailScriptFile(File scriptDirectory, String fileName) throws IOException {
    createScriptFile(scriptDirectory, "exit 1\n", fileName);
  }
