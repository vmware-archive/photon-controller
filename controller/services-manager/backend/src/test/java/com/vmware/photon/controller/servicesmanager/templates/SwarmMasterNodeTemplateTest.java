...
/**
 * Implements tests for {@link SwarmMasterNodeTemplate}.
 */
public class SwarmMasterNodeTemplateTest {

  private SwarmMasterNodeTemplate template = new SwarmMasterNodeTemplate();
  ...
  private Map<String, String> createCloudConfigProperties() {
    return SwarmMasterNodeTemplate.createProperties(createEtcdAddresses());
  }
  ...
  public class CreateUserDataTemplateTest {
    ...
    public void testSuccess() {
      ...
      String swarmPort = userData.parameters.get("$SWARM_PORT");
      assertEquals(swarmPort, Integer.toString(ServicesManagerConstants.Swarm.SWARM_PORT));
    }
  ...
  public class CreatePropertiesTest {
    ...
    public void testNullEtcdAddresses() {
      SwarmMasterNodeTemplate.createProperties(null);
    }

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void testEmpltyEtcdAddresses() {
      SwarmMasterNodeTemplate.createProperties(new ArrayList<>());
    }
  }
}
