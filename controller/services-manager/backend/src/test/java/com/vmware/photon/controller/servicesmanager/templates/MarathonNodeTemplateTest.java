...
/**
 * Implements tests for {@link MarathonNodeTemplate}.
 */
public class MarathonNodeTemplateTest {

  private MarathonNodeTemplate template = new MarathonNodeTemplate();
  ...
  private Map<String, String> createCloudConfigProperties() {
    return MarathonNodeTemplate.createProperties(createZookeeperAddresses());
  }
  ...
  public class GetVmNameTest {
    ...
    public void testGetVmName() {
      ...
      assertEquals(name, "marathon-" + hostId);
    }
  }
  ...
  public class CreateUserDataTemplateTest {
    ...
    public void testSuccess() {
      ...
      String hostname = userData.parameters.get("$LOCAL_HOSTNAME");
  ...
  public class CreatePropertiesTest {
    ...
    public void testNullZookeeperAddresses() {
      MarathonNodeTemplate.createProperties(null);
    }

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void testEmpltyZookeeperAddresses() {
      MarathonNodeTemplate.createProperties(new ArrayList<>());
    }
  }
}
