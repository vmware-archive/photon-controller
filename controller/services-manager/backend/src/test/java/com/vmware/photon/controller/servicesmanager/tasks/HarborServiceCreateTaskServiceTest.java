...
import com.vmware.photon.controller.servicesmanager.statuschecks.HarborStatusChecker;
...
/**
 * This class implements tests for the {@link HarborServiceCreateTaskService} class.
 */
public class HarborServiceCreateTaskServiceTest {

  private TestHost host;
  private HarborServiceCreateTaskService taskService;
  ...
  private HarborServiceCreateTaskState buildValidStartState(
      TaskState.TaskStage stage, HarborServiceCreateTaskState.TaskState.SubStage subStage) throws Throwable {

    HarborServiceCreateTaskState state = ReflectionUtils.buildValidStartState(HarborServiceCreateTaskState.class);
  ...
  private HarborServiceCreateTaskState buildValidPatchState(
      TaskState.TaskStage stage, HarborServiceCreateTaskState.TaskState.SubStage subStage) {

    HarborServiceCreateTaskState patchState = new HarborServiceCreateTaskState();
    patchState.taskState = new HarborServiceCreateTaskState.TaskState();
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      taskService = new HarborServiceCreateTaskService();
    }
  ...
  public class HandleStartTest {
    ...
    public void testValidStartState(TaskState.TaskStage stage,
                                    HarborServiceCreateTaskState.TaskState.SubStage subStage) throws Throwable {

      HarborServiceCreateTaskState startState = buildValidStartState(stage, subStage);

      Operation startOp = host.startServiceSynchronously(taskService, startState);
      assertThat(startOp.getStatusCode(), is(200));
      HarborServiceCreateTaskState savedState = host.getServiceState(
          HarborServiceCreateTaskState.class);
    ...
    public Object[][] getValidStartStates() {
      ...
      return new Object[][]{
          ...
          {TaskState.TaskStage.STARTED,
              HarborServiceCreateTaskState.TaskState.SubStage.SETUP_HARBOR},
    ...
    public void testMissingStateValue(String attributeName) throws Throwable {
      HarborServiceCreateTaskState startState = buildValidStartState(null, null);
    ...
    public Object[][] getAttributeNames() {
      List<String> notNullAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          HarborServiceCreateTaskState.class, NotNull.class);
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageUpdates(TaskState.TaskStage startStage,
                                      HarborServiceCreateTaskState.TaskState.SubStage startSubStage,
                                      TaskState.TaskStage patchStage,
                                      HarborServiceCreateTaskState.TaskState.SubStage patchSubStage) throws Throwable {

      HarborServiceCreateTaskState startState = buildValidStartState(startStage, startSubStage);
      host.startServiceSynchronously(taskService, startState);

      HarborServiceCreateTaskState patchState = buildValidPatchState(patchStage, patchSubStage);
      ...
      HarborServiceCreateTaskState savedState = host.getServiceState(HarborServiceCreateTaskState.class);
    ...
    public Object[][] getValidStageUpdates()
      ...
      return new Object[][]{
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.STARTED, HarborServiceCreateTaskState.TaskState.SubStage.SETUP_HARBOR},
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.FAILED, null},
          {TaskState.TaskStage.CREATED, null,
              TaskState.TaskStage.CANCELLED, null},
    ...
    public void testInvalidSubStageUpdates(TaskState.TaskStage startStage,
                                           HarborServiceCreateTaskState.TaskState.SubStage startSubStage,
                                           TaskState.TaskStage patchStage,
                                           HarborServiceCreateTaskState.TaskState.SubStage patchSubStage)
        throws Throwable {
    ...
    public void testInvalidPatchImmutableFieldChanged(String fieldName) throws Throwable {
      HarborServiceCreateTaskState startState = buildValidStartState(TaskState.TaskStage.CREATED, null);
      Operation startOperation = host.startServiceSynchronously(taskService, startState);
      assertThat(startOperation.getStatusCode(), is(200));

      HarborServiceCreateTaskState patchState = buildValidPatchState(TaskState.TaskStage.STARTED,
          HarborServiceCreateTaskState.TaskState.SubStage.SETUP_HARBOR);
    ...
    public Object[][] getImmutableFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              HarborServiceCreateTaskState.class, Immutable.class));
    }
  }

  /**
   * End-to-end tests for the Harbor service create task.
   */
  public class EndToEndTest {
    ...
    public void setUpTest() throws Throwable {
      ...
      Path userDataTemplate =
          Paths.get(scriptDirectory.getAbsolutePath(), HarborNodeTemplate.USER_DATA_TEMPLATE);
      ...
      harborNodeIps = new HashSet<>();
      harborNodeIps.add("100.0.0.1");
    ...
    public void testEndToEndSuccess(int serviceSize, com.vmware.photon.controller.api.model.ServiceState expectedState)
      ...
      HarborServiceCreateTaskState savedState = machine.callServiceAndWaitForState(
          HarborServiceCreateTaskFactory.SELF_LINK,
          startState,
          HarborServiceCreateTaskState.class,
      ...
      assertThat(service.extendedProperties.size(), is(6));
      assertThat(service.extendedProperties.get(ServicesManagerConstants.EXTENDED_PROPERTY_CA_CERTIFICATE),
          is("ca-cert"));
      assertThat(service.extendedProperties.containsKey(ServicesManagerConstants.EXTENDED_PROPERTY_ADMIN_PASSWORD),
          is(false));
    }
    ...
    public void testEndToEndFailureWaitServiceVmFails() throws Throwable {
      ...
      HarborStatusChecker statusChecker = mock(HarborStatusChecker.class);
    ...
    private void createServiceEntity(int size) throws Throwable {
      ...
      service.serviceName = "harborService";
      service.serviceType = ServiceType.HARBOR;
      ...
      service.extendedProperties.put(ServicesManagerConstants.EXTENDED_PROPERTY_SSH_KEY, "test-key");
      service.extendedProperties.put(ServicesManagerConstants.EXTENDED_PROPERTY_ADMIN_PASSWORD, "admin-password");
    ...
    private void mockHarborClient() throws Throwable {
      doAnswer(invocation -> {
