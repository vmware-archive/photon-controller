...
/**
 * Implements tests for {@link BasicNodeRollout}.
 */
public class BasicNodeRolloutTests {
  ...
  private NodeRolloutInput buildValidInput() {
    ...
    input.serviceId = UUID.randomUUID().toString();
  ...
  public class ValidationTests {
    ...
    public void testNullService() {
      BasicNodeRollout rollout = new BasicNodeRollout();
    ...
    public void testNullNodeRolloutInput() {
      BasicNodeRollout rollout = new BasicNodeRollout();
      rollout.run(new ServiceWaitTask(), null, new FutureCallback<NodeRolloutResult>() {
        @Override
        public void onSuccess(NodeRolloutResult result) {
          fail("Expected to throw NullPointerException");
        }
    ...
    public void testInvalidNodeRolloutInput() {
      ...
      BasicNodeRollout rollout = new BasicNodeRollout();
      rollout.run(new ServiceWaitTask(), input, new FutureCallback<NodeRolloutResult>() {
        @Override
        public void onSuccess(NodeRolloutResult result) {
          fail("Expected to throw NullPointerException");
        }
