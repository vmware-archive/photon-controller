...
/**
 * This class implements tests for the {@link ServiceExpandTask} class.
 */
public class ServiceExpandTaskTest {
  ...
  private ServiceExpandTask.State buildValidStartState(TaskState.TaskStage startStage) throws Throwable {
    ServiceExpandTask.State startState =
        ReflectionUtils.buildValidStartState(ServiceExpandTask.State.class);
  ...
  private ServiceExpandTask.State buildValidPatchState(TaskState.TaskStage patchStage) {
    ServiceExpandTask.State patchState = new ServiceExpandTask.State();
  ...
  public class InitializationTest {
    ...
    private ServiceExpandTask service;

    @BeforeMethod
    public void setUpTest() {
      service = new ServiceExpandTask();
    }
  ...
  public class HandleStartTest {
    ...
    private void startService(ServiceExpandTask.State startState) throws Throwable {
    ...
    public void testValidStartState(@Nullable TaskState.TaskStage startStage) throws Throwable {
      ...
      testHost.getServiceState(ServiceExpandTask.State.class);
    }
    ...
    public void testTransitionalStartStage(@Nullable TaskState.TaskStage startStage) throws Throwable {
      startService(buildValidStartState(startStage));
      ServiceExpandTask.State serviceState = testHost
          .getServiceState(ServiceExpandTask.State.class);
    ...
    public void testInvalidStartStateMissingRequiredField(String fieldName) throws Throwable {
      ServiceExpandTask.State startState = buildValidStartState(null);
    ...
    public Object[][] getNotNullFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              ServiceExpandTask.State.class, NotNull.class));
    }
  }
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageTransition(TaskState.TaskStage startStage, TaskState.TaskStage patchStage)
        throws Throwable {
      startService(buildValidStartState(startStage));
      ServiceExpandTask.State patchState = buildValidPatchState(patchStage);
    ...
    public void testInvalidPatchImmutableFieldSet(String fieldName) throws Throwable {
      ...
      ServiceExpandTask.State patchState = buildValidPatchState(TaskState.TaskStage.STARTED);
    ...
    public Object[][] getImmutableFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              ServiceExpandTask.State.class, Immutable.class));
    }
  }
  ...
  public class EndToEndTest {
    ...
    private ServiceExpandTask.State startState;
    ...
    @Test(dataProvider = "successServiceExpandNodeCounts")
    public void testEndToEndSuccess(ServiceType serviceType, int currentWorkerCount, int expectedWorkerCount)
        throws Throwable {

      mockService(serviceType, expectedWorkerCount);
      mockGetServiceVms(currentWorkerCount, true);
      mockVmProvision(true);

      ServiceExpandTask.State savedState = machine.callServiceAndWaitForState(
    ...
    @DataProvider(name = "successServiceExpandNodeCounts")
    public Object[][] getSuccessServiceExpandNodeCounts() {
      return new Object[][]{
          {ServiceType.KUBERNETES, 5, 5},
          {ServiceType.KUBERNETES, 5, 7},
          {ServiceType.KUBERNETES, 10, 50},
          {ServiceType.KUBERNETES, 10, 60},
          {ServiceType.HARBOR, 0, 0}
      };
    }
    ...
    public void testEndToEndFailureRolloutFails() throws Throwable {
      ...
      mockService(ServiceType.KUBERNETES, 5);
      mockGetServiceVms(7, true);
    ...
    private void mockGetServiceVms(int nodeCount, boolean isSuccess) throws Throwable {
      if (isSuccess) {
        ...
        final Set<String> vmMasterTags = ImmutableSet.of(ServicesUtil.createServiceNodeTag(
            startState.serviceId, NodeType.KubernetesMaster));
        final Set<String> vmWorkerTags = ImmutableSet.of(ServicesUtil.createServiceNodeTag(
            startState.serviceId, NodeType.KubernetesWorker));
    ...
    private void mockService(ServiceType serviceType, int workerCount) throws Throwable {
      ...
      serviceState.extendedProperties.put(
          ServicesManagerConstants.EXTENDED_PROPERTY_ETCD_IPS, "10.0.0.2,10.0.0.3,10.0.0.4");
