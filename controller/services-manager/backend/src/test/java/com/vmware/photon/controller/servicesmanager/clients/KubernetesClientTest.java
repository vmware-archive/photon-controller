...
package com.vmware.photon.controller.servicesmanager.clients;
...
public class KubernetesClientTest {
  ...
  public class GetNodeAddressesAsyncTest {
    ...
    public void testGetAddressesSuccess() throws IOException, InterruptedException {
      String serviceJson = Resources.toString(
          KubernetesClientTest.class.getResource("/kubernetes_service.json"), Charsets.UTF_8);

      asyncHttpClient = HttpClientTestUtil.setupMocks(serviceJson, HttpStatus.SC_OK);
  ...
  public class GetVersionAsyncTest {
    ...
    @Test
    public void testGetVersionSuccess() throws IOException, InterruptedException {
      String serviceJson = Resources.toString(
    ...
    @Test
    public void testBadInputForVersion() throws IOException, InterruptedException {
      String serviceJson = Resources.toString(
          KubernetesClientTest.class.getResource("/kubernetes_version_null.json"), Charsets.UTF_8);
      asyncHttpClient = HttpClientTestUtil.setupMocks(serviceJson, HttpStatus.SC_OK);
      KubernetesClient client = new KubernetesClient(asyncHttpClient);
      ...
      client.getVersionAsync(CONNECTION_STRING, new FutureCallback<String>() {
        @Override
        public void onSuccess(@Nullable String version) {
          fail("getVersion was expected to fail.");
          latch.countDown();
        }
