...
/**
 * This class implements tests for the {@link ServiceWaitTask} class.
 */
public class ServiceWaitTaskTest {
  ...
  private ServiceWaitTask.State buildValidStartState(@Nullable TaskState.TaskStage startStage) {
  ...
  public class InitializationTest {
    ...
    private ServiceWaitTask waitTaskService;

    @BeforeMethod
    public void setUpTest() {
      waitTaskService = new ServiceWaitTask();
    }
  ...
  public class HandleStartTest {
    ...
    private void startService(ServiceWaitTask.State startState) throws Throwable {
    ...
    public void testValidStartState(@Nullable TaskState.TaskStage startStage) throws Throwable {
      ...
      ServiceWaitTask.State serviceState = testHost
          .getServiceState(ServiceWaitTask.State.class);
    ...
    public void testInvalidStartStateMissingRequiredField(String fieldName) throws Throwable {
      ServiceWaitTask.State startState = buildValidStartState(null);
    ...
    public Object[][] getNotNullFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              ServiceWaitTask.State.class, NotNull.class));
    }
  }
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageTransition(TaskState.TaskStage startStage, TaskState.TaskStage patchStage)
        throws Throwable {
      startService(buildValidStartState(startStage));
      ServiceWaitTask.State patchState = ServiceWaitTask
    ...
    public void testInvalidPatchImmutableFieldSet(String fieldName) throws Throwable {
      ...
      ServiceWaitTask.State patchState =
          ServiceWaitTask.buildPatch(TaskState.TaskStage.STARTED, null);
    ...
    public Object[][] getImmutableFieldNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              ServiceWaitTask.State.class, Immutable.class));
    }
  }
  ...
  public class EndToEndTest {
    ...
    private ServiceWaitTask.State startState;
    ...
    public void testEndToEndSuccess(NodeType nodeType) throws Throwable {
      ...
      ServiceWaitTask.State serviceState =
