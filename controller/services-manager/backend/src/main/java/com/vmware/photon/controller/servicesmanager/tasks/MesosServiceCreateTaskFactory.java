 ...
 * {@link MesosServiceCreateTask} instances.
 */
public class MesosServiceCreateTaskFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.MESOS_SERVICE_CREATE_TASK;

  public MesosServiceCreateTaskFactory() {
    super(MesosServiceCreateTaskState.class);
  }

  @Override
  public Service createServiceInstance() throws Throwable {
    return new MesosServiceCreateTask();
  }
}
