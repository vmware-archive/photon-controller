...
package com.vmware.photon.controller.servicesmanager.statuschecks;
...
/**
 * Defines the interface for fetching set of worker nodes of a service.
 */
public interface WorkersStatusChecker {
  /**
   * Determines the status of a single or multiple nodes in a service.
  ...
  /**
   * Fetches worker nodes of a service.
