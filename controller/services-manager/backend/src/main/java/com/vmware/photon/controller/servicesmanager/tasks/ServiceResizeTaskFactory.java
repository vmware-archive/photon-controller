 ...
 * {@link ServiceResizeTask} instances.
 */
public class ServiceResizeTaskFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.SERVICE_RESIZE_TASK;

  public ServiceResizeTaskFactory() {
    super(ServiceResizeTaskState.class);
  }

  @Override
  public Service createServiceInstance() throws Throwable {
    return new ServiceResizeTask();
  }
}
