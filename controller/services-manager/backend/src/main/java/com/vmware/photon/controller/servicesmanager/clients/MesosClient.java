...
/**
 * This class represents a simple Rest Client to call into Mesos Rest APIs to query the status of the service.
 */
public class MesosClient {
  ...
  /**
   * Represents the contract object used to represent Mesos Service State,
  ...
  /**
   * Represents the contract object used to represent a specific Mesos Service Slave,
   * as returned by the GET /nodes API.
   */
