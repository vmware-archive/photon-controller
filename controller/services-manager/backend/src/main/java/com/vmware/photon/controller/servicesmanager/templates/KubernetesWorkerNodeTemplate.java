...
public class KubernetesWorkerNodeTemplate implements NodeTemplate {
  ...
  public FileTemplate createUserDataTemplate(String scriptDirectory, Map<String, String> properties) {
    ...
    parameters.put("$KUBERNETES_PORT", String.valueOf(ServicesManagerConstants.Kubernetes.API_PORT));
    ...
    parameters.put("$CA_CERT", KubernetesMasterNodeTemplate.fixIndentationForCertificate(caCert));
