...
/**
 * This class represents a simple Rest Client to call into Kubernetes Rest APIs to query the status of the service.
 */
public class KubernetesClient {
   ...
   *
   * @param connectionString          connectionString of the master Node in the Service
  ...
  /**
   * Represents the contract object used to represent Kubernetes Service Nodes,
  ...
  /**
   * Represents the contract object used to represent a specific Kubernetes Service Node,
   * as returned by the GET /nodes API.
   */
