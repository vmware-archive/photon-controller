 ...
 * {@link KubernetesServiceCreateTask} instances.
 */
public class KubernetesServiceCreateTaskFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.KUBERNETES_SERVICE_CREATE_TASK;

  public KubernetesServiceCreateTaskFactory() {
    super(KubernetesServiceCreateTaskState.class);
  }

  @Override
  public Service createServiceInstance() throws Throwable {
    return new KubernetesServiceCreateTask();
  }
}
