 ...
 * representing an inactive Vm in Service.
 */
public class InactiveVmService extends StatefulService {
   ...
   *
   * Due to versioning issues with service images we do not support migrating service states.
   */
  @NoMigrationDuringUpgrade
  @NoMigrationDuringDeployment
  public static class State extends ServiceDocument {
    /**
     * Represents the service that this vm belongs to.
     */
    @NotNull
    @Immutable
