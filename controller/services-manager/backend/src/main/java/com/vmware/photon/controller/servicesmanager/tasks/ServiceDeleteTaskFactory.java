 ...
 * {@link ServiceDeleteTaskState} instances.
 */
public class ServiceDeleteTaskFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.SERVICE_DELETE_TASK;

  public ServiceDeleteTaskFactory() {
    super(ServiceDeleteTaskState.class);
  }

  @Override
  public Service createServiceInstance() throws Throwable {
    return new ServiceDeleteTask();
  }
}
