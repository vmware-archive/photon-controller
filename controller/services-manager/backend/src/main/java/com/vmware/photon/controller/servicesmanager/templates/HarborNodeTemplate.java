...
public class HarborNodeTemplate implements NodeTemplate {
  ...
  public FileTemplate createUserDataTemplate(String scriptDirectory, Map<String, String> properties) {
    ...
    parameters.put("$HARBOR_PORT", String.valueOf(ServicesManagerConstants.Harbor.HARBOR_PORT));
  ...
  public static Map<String, String> createProperties(
      String dns, String gateway, String netmask, String ip, String sshKey, String adminPassword) {
    ...
    Preconditions.checkNotNull(adminPassword, "adminPassword cannot be null");
    ...
    properties.put(ADMIN_PASSWORD_PROPERTY, adminPassword);
