...
package com.vmware.photon.controller.scheduler.helpers.xenon;
...
public class SchedulerTestEnvironment extends MultiHostEnvironment<PhotonControllerXenonHost> {
  ...
  private SchedulerTestEnvironment(HostClientFactory hostClientFactory, SchedulerConfig config,
    ...
    for (int i = 0; i < hosts.length; i++) {
      ...
      hosts[i] = new PhotonControllerXenonHost(xenonConfig, hostClientFactory, null, null, cloudStoreHelper, null);
   ...
   * @throws Throwable
   */
  public static SchedulerTestEnvironment create(HostClientFactory hostClientFactory, SchedulerConfig config,
