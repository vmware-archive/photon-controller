...
/**
 * Represent a port on tier1 router that connects to tier0 router.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class LogicalRouterLinkPortOnTier1 {
  ...
  public boolean equals(Object o) {
    ...
    LogicalRouterLinkPortOnTier1 other = (LogicalRouterLinkPortOnTier1) o;
