...
/**
 * This class represents a NatRuleCreateSpec JSON structure.
 */
@JsonIgnoreProperties(ignoreUnknown =  true)
public class NatRuleCreateSpec {
  ...
  public boolean equals(Object o) {
    ...
    NatRuleCreateSpec other = (NatRuleCreateSpec) o;
    return Objects.equals(getNatAction(), other.getNatAction())
