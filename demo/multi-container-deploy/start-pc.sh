...
ENABLE_FQDN=0
UI_CONTAINER_VERSION=1.0.0
PC_CONTAINER_VERSION=1.0.3
LW_CONTAINER_VERSION=latest
...
echo "---------------------------------"
echo "Step 4/6: Start Photon Controller"
echo "---------------------------------"
...
echo "---------------------------------"
echo "Step 5/6: Create Users and Groups"
echo "---------------------------------"
...
echo "------------------------------------"
echo "Step 6/6: Start Photon Controller UI"
echo "------------------------------------"
