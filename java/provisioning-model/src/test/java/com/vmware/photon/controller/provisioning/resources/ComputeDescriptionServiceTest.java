...
import com.vmware.photon.controller.provisioning.helpers.ReusableHost;
...
public class ComputeDescriptionServiceTest {
   ...
   */
  public class HandleStartTest extends ReusableHost {

    @Test(groups = {ReusableHost.TAG})
    ...
    @Test(groups = {ReusableHost.TAG}, expectedExceptions = IllegalArgumentException.class)
