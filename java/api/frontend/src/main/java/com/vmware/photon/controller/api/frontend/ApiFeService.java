...
import com.vmware.photon.controller.api.frontend.config.ApiFeStaticConfiguration;
...
import com.vmware.photon.controller.api.frontend.filter.LoggingFilter;
import com.vmware.photon.controller.api.frontend.filter.NetworkToSubnetRedirectionFilter;
import com.vmware.photon.controller.api.frontend.filter.PauseFilter;
import com.vmware.photon.controller.api.frontend.filter.UrlTrailingSlashFilter;
import com.vmware.photon.controller.api.frontend.jackson.GuiceModule;
import com.vmware.photon.controller.api.frontend.providers.ConstraintViolationExceptionMapper;
import com.vmware.photon.controller.api.frontend.providers.ExternalExceptionMapper;
...
import com.vmware.photon.controller.api.frontend.resources.system.DataQuorumResource;
...
import com.vmware.photon.controller.api.frontend.resources.cluster.ClusterResizeResource;
...
import com.vmware.photon.controller.api.frontend.resources.datastore.DatastoreResource;
import com.vmware.photon.controller.api.frontend.resources.datastore.DatastoresResource;
import com.vmware.photon.controller.api.frontend.resources.deployment.DeploymentAdminGroupsResource;
import com.vmware.photon.controller.api.frontend.resources.deployment.DeploymentResource;
import com.vmware.photon.controller.api.frontend.resources.deployment.DeploymentsResource;
import com.vmware.photon.controller.api.frontend.resources.disk.DiskResource;
import com.vmware.photon.controller.api.frontend.resources.disk.ProjectDisksResource;
import com.vmware.photon.controller.api.frontend.resources.flavor.FlavorResource;
import com.vmware.photon.controller.api.frontend.resources.flavor.FlavorsResource;
import com.vmware.photon.controller.api.frontend.resources.host.DeploymentHostsResource;
...
import com.vmware.photon.controller.api.frontend.resources.project.ProjectSecurityGroupsResource;
...
import com.vmware.photon.controller.api.frontend.resources.tasks.HostTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.ImageTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.ProjectTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.ResourceTicketTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.TaskResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.TasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.TenantTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tasks.VmTasksResource;
import com.vmware.photon.controller.api.frontend.resources.tenant.TenantResource;
import com.vmware.photon.controller.api.frontend.resources.tenant.TenantSecurityGroupsResource;
import com.vmware.photon.controller.api.frontend.resources.tenant.TenantsResource;
import com.vmware.photon.controller.api.frontend.resources.virtualnetwork.ProjectNetworksResource;
import com.vmware.photon.controller.api.frontend.resources.vm.ClusterVmsResource;
...
import com.vmware.photon.controller.api.frontend.resources.vm.VmIsoAttachResource;
import com.vmware.photon.controller.api.frontend.resources.vm.VmIsoDetachResource;
import com.vmware.photon.controller.api.frontend.resources.vm.VmMetadataSetResource;
...
public class ApiFeService extends Application<ApiFeStaticConfiguration> {
  ...
  private void registerResourcesWithSwagger(ApiFeConfiguration configuration, Environment environment) {
    ...
    resources.add(DataQuorumResource.class);
    ...
    if (!apiFeConfiguration.useVirtualNetwork()) {
      ...
      resources.add(com.vmware.photon.controller.api.frontend.resources.virtualnetwork.SubnetResource.class);
