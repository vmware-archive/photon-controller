 ...
 */
public class DiskBackend {

  private static final Logger logger = LoggerFactory.getLogger(DiskBackend.class);
  ...
  @Inject
  public DiskBackend(ApiFeXenonRestClient xenonClient, ProjectBackend projectBackend, FlavorBackend flavorBackend,
