...
public class ClusterManagerClient {
  ...
  @Inject
  public ClusterManagerClient(PhotonControllerXenonRestClient xenonClient, ApiFeXenonRestClient apiFeXenonClient)
  ...
  private String createKubernetesClusterEntity(String projectId,
    ...
    String caCert = spec.getExtendedProperties().get(ClusterManagerConstants.EXTENDED_PROPERTY_REGISTRY_CA_CERTIFICATE);
    ...
    if (caCert != null) {
      cluster.extendedProperties.put(ClusterManagerConstants.EXTENDED_PROPERTY_REGISTRY_CA_CERTIFICATE, caCert);
    }
  ...
  private Cluster toApiRepresentation(ClusterService.State clusterDocument) {
    ...
    if (clusterDocument.errorReason != null && !clusterDocument.errorReason.isEmpty()) {
