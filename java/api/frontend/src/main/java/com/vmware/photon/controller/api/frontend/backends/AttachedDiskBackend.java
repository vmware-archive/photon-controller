...
/**
 * AttachedDiskBackend is performing attach disk and detach disk operations.
 */
public class AttachedDiskBackend {
  private static final Logger logger = LoggerFactory.getLogger(AttachedDiskBackend.class);

  private final ApiFeXenonRestClient xenonClient;
  private final DiskBackend diskBackend;

  @Inject
  public AttachedDiskBackend(ApiFeXenonRestClient xenonClient, DiskBackend diskBackend) {
