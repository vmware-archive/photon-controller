...
@Path(SystemRoutes.DATA_QUORUM_PATH)
...
public class DataQuorumResource {
    ...
    public void post(@Context Request request) throws InterruptedException, BadRequestException, TimeoutException, DocumentNotFoundException {
        updateQuorum(1);
    }
