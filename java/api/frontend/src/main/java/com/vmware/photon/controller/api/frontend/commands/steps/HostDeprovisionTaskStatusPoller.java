...
import com.vmware.photon.controller.api.frontend.exceptions.external.HostDeprovisionFailedException;
...
public class HostDeprovisionTaskStatusPoller implements XenonTaskStatusStepCmd.XenonTaskStatusPoller {
  ...
  public HostDeprovisionTaskStatusPoller(TaskCommand taskCommand, HostXenonBackend hostBackend,
