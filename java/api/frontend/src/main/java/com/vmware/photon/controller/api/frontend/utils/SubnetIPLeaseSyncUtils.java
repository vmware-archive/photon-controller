...
public class SubnetIPLeaseSyncUtils {
  ...
  /**
   * Creates a post request to SubnetIPLeaseSyncTriggerService.
   *
   * @param subnetId
   * @param taskCommand
   * */
  public static void triggerSubnetIPLeaseSync(String subnetId, TaskCommand taskCommand) {
    ...
    photonControllerXenonRestClient.post(
            SubnetIPLeaseSyncTriggerService.SELF_LINK , state);
  }
}
