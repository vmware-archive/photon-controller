...
/**
 * Test {@link com.vmware.photon.controller.api.frontend.resources.tasks.FlavorTasksResource}.
 */
public class FlavorTasksResourceTest extends ResourceTest {
  ...
  public void testGetFlavorTasks(Optional<Integer> pageSize,
    ...
    when(client.getFlavorTasks(flavorId, Optional.<String>absent(), Optional.of(2)))
        .thenReturn(new ResourceList<Task>(ImmutableList.of(task1, task2), null, null));
    when(client.getFlavorTasks(flavorId, Optional.<String>absent(), Optional.of(3)))
  ...
  @Test
  public void testGetFlavorTasksPage() throws Exception {
    task1.setId(taskId1);
    task2.setId(taskId2);
  ...
  private Response getTasks(String pageLink) {
    String uri = flavorTaskRoute + "?pageLink=" + pageLink;
