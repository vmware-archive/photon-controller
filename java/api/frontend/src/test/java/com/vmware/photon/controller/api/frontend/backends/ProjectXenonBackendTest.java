...
public class ProjectXenonBackendTest {
  ...
  public static class GetNumberTest {
    ...
    @Test
    public void testGetProjectSizeByDeployment() throws Exception {
      int num = projectBackend.getNumberProjects(Optional.<String>absent());
      assertThat(num, is(2));
    }

    @Test
    public void testGetProjectSizeByValidTenantId() throws Exception {
      int num = projectBackend.getNumberProjects(Optional.of(tenantId1));
      assertThat(num, is(1));
      num = projectBackend.getNumberProjects(Optional.of(tenantId2));
      assertThat(num, is(1));
    }

    @Test
    public void testGetProjectSizeByInValidTenantId() {
      int num = projectBackend.getNumberProjects(Optional.of("not_exist_tenant_id"));
      assertThat(num, is(0));
    }
  }
}
