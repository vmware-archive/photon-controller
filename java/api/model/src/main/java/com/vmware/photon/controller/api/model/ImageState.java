 ...
 * <p/>
 * - CREATING - the DB entities have been created, the image has an ID.
 * On success will transition to READY.
 * <p/>
 * - READY - means the image is uploaded successfully to shared datastore.
 * <p/>
 * - PENDING_DELETE - means the image is was deleted by the user but there
 * are active VMs that were instantiated from the image.
 * <p/>
 * - DELETED - the image is a deleted tombstone
 * <p/>
 * - ERROR - image creation has failed
 */
public enum ImageState {
   ...
   */
  public static final Map<ImageState, Set<ImageState>> PRECONDITION_STATES =
      ImmutableMap.<ImageState, Set<ImageState>>builder()
          .put(CREATING, ImmutableSet.<ImageState>of())
