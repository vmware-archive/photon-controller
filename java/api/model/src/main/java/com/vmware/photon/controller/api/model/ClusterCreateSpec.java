...
public class ClusterCreateSpec implements Named {
  ...
  @JsonProperty
  @ApiModelProperty(value = "This property specifies extra attributes for the cluster. There is an extended" +
  "set of attributes: please see the documentation for the complete list.", required = true)
  @NotNull
  @Size(min = 1)
