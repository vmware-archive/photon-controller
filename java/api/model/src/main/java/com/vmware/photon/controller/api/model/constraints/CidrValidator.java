...
public class CidrValidator implements ConstraintValidator<Cidr, String> {
  ...
  public static final int CIDR_BIT_MASK_MAX_VALUE = 32;
  ...
  public boolean isValid(String value, ConstraintValidatorContext context) {
    ...
    boolean validIpAddress = InetAddressValidator.getInstance().isValid(cidr[0]);
    int bitMask = (cidr.length > 1 && cidr[1].matches("\\d+") ? Integer.parseInt(cidr[1]) : 0);
