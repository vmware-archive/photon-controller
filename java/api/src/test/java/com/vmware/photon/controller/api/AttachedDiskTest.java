...
public class AttachedDiskTest {
  ...
  public void testIsAFlavoredCompact() throws Exception {
    assertThat(disk, isA(FlavoredCompact.class));
  }
  ...
  public void testSerializesToJson() throws Exception {
    assertThat(asJson(disk), is(equalTo(jsonFixture("fixtures/attached-disk.json"))));
  }

  @Test
  public void testDeserializesFromJson() throws Exception {
    assertThat(fromJson(jsonFixture("fixtures/attached-disk.json"), AttachedDisk.class), is(disk));
  }
}
