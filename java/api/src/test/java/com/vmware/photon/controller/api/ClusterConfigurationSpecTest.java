...
public class ClusterConfigurationSpecTest {
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      String json = jsonFixture("fixtures/cluster-configuration-spec.json");
      assertThat(asJson(clusterConfigurationSpec), is(equalTo(json)));
      assertThat(fromJson(json, ClusterConfigurationSpec.class), is(clusterConfigurationSpec));
    }
  }
