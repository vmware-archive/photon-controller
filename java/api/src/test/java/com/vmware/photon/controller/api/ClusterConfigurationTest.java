...
public class ClusterConfigurationTest {
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      String json = jsonFixture("fixtures/cluster-configuration.json");
      assertThat(asJson(clusterConfiguration), is(equalTo(json)));
      assertThat(fromJson(json, ClusterConfiguration.class), is(clusterConfiguration));
    }
  }
