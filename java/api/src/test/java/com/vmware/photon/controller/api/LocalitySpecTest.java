...
public class LocalitySpecTest {
  ...
  public void testSerialization() throws Exception {
    ...
    String json = jsonFixture("fixtures/localityspec.json");

    assertThat(fromJson(json, LocalitySpec.class), is(localitySpec));
    assertThat(asJson(localitySpec), sameJSONAs(json).allowingAnyArrayOrdering());
  }
}
