...
public class HostCreateSpecTest {
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws Exception {
      String json = jsonFixture("fixtures/hostcreate.json");

      assertThat(fromJson(json, HostCreateSpec.class), is(hostCreateSpec));
      assertThat(asJson(hostCreateSpec), sameJSONAs(json).allowingAnyArrayOrdering());
    }
  }
}
