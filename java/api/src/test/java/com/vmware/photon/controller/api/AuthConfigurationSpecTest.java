...
public class AuthConfigurationSpecTest {
  ...
  private static final String AUTH_INFO_JSON_FILE = "fixtures/auth-configuration-spec-with-data.json";
  private static final String EMPTY_AUTH_INFO_JSON_FILE = "fixtures/auth-configuration-spec-no-data.json";
