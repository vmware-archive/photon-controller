...
/**
 * Tests {@link com.vmware.photon.controller.api.HostSetAvailabilityZoneOperation}.
 */
public class HostSetAvailabilityZoneOperationTest {
  ...
  /**
   * Tests for {@link com.vmware.photon.controller.api.HostSetAvailabilityZoneOperation#availabilityZoneId}.
   */
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      ...
      String json = jsonFixture("fixtures/host-set-availability-zone-operation.json");
      assertThat(asJson(operation), is(equalTo(json)));
      assertThat(fromJson(json, HostSetAvailabilityZoneOperation.class), is(operation));
    }
  }

  /**
   * Tests for {@link com.vmware.photon.controller.api.HostSetAvailabilityZoneOperation#toString()}.
   */
