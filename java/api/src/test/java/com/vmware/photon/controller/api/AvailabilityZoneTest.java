...
/**
 * Tests {@link com.vmware.photon.controller.api.AvailabilityZone}.
 */
public class AvailabilityZoneTest {
  ...
  /**
   * Tests {@link com.vmware.photon.controller.api.AvailabilityZone#toString()}.
   */
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws Exception {
      ...
      assertThat(asJson(availabilityZone), is(equalTo(json)));
      assertThat(fromJson(json, AvailabilityZone.class), is(availabilityZone));
    }
  }
}
