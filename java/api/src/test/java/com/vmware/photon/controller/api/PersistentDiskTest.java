...
import com.vmware.photon.controller.api.base.Infrastructure;
...
public class PersistentDiskTest {
  ...
  public class SerializationTest {
    ...
    public void testSerialization() throws IOException {
      assertThat(asJson(disk), sameJSONAs(jsonFixture(JSON_FILE)).allowingAnyArrayOrdering());
    ...
    public void testDeserialization() throws IOException {
      ...
      assertThat(fromJson(jsonFixture(JSON_FILE), PersistentDisk.class), is(disk));
    }
