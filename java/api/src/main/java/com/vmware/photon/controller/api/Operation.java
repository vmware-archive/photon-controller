...
public enum Operation {
  ...
  CREATE_KUBERNETES_CLUSTER_ALLOCATE_RESOURCES("AllocateResources"),
  ...
  CREATE_MESOS_CLUSTER_ALLOCATE_RESOURCES("AllocateResources"),
  ...
  CREATE_SWARM_CLUSTER_ALLOCATE_RESOURCES("AllocateResources"),
