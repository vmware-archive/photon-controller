...
public class RestClient {
  ...
  public HttpResponse perform(final Method method, final String path, final HttpEntity payload)
    ...
    try {
      ...
      if (statusCode == HttpStatus.SC_UNAUTHORIZED) {
        ...
        AuthOIDCClient authOIDCClient = new AuthOIDCClient("https://10.118.97.244", 443, "esxcloud");
  ...
  public OIDCTokens getToken(String userName, String password, AuthTokenHandler authTokenHandler) {
