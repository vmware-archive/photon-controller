 ...
 * IpLeaseCleanerService instances.
 */
public class IpLeaseCleanerTriggerBuilder implements TaskStateBuilder {

  /**
   * Link for the trigger service.
   */
  public static final String TRIGGER_SELF_LINK = "/ip-lease-cleans";
   ...
   */
  public IpLeaseCleanerTriggerBuilder(Long triggerInterval, Long taskExpirationAge) {
