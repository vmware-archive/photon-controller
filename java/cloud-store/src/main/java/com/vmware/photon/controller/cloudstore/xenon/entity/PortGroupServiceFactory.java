 ...
 * {@link PortGroupService} instances.
 */
public class PortGroupServiceFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.CLOUDSTORE_ROOT + "/portgroups";
