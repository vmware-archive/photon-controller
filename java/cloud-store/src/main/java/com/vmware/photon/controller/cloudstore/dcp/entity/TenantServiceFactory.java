...
/**
 * Class TenantServiceFactory is a factory to create a TenantService instances.
 */
public class TenantServiceFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.CLOUDSTORE_ROOT + "/tenants";
