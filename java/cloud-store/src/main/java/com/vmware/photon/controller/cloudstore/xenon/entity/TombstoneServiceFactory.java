...
/**
 * Class TombstoneServiceFactory is a factory to create a TombstoneService instances.
 */
public class TombstoneServiceFactory extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.CLOUDSTORE_ROOT + "/tombstones";
