...
public class PortGroupService extends StatefulService {
   ...
   */
  @Upgrade(transformationServicePath = UpgradeUtils.REFLECTION_TRANSFORMATION_SERVICE_LINK,
      sourceFactoryServicePath = PortGroupServiceFactory.SELF_LINK,
      destinationFactoryServicePath = PortGroupServiceFactory.SELF_LINK,
