...
public class AvailabilityZoneCleanerTriggerBuilder implements TaskStateBuilder {
  ...
  /**
   * Default age after which to expire a availability zone. (5m)
   */
  public static final long DEFAULT_AVAILABILITY_ZONE_EXPIRATION_AGE_MILLIS = TimeUnit.MINUTES.toMillis(5);
  ...
  /**
   * Age at which availability zone entities expire.
   */
  private final Long availabilityZoneExpirationAgeMillis;
   ...
   * @param availabilityZoneExpirationAge (in milliseconds)
   */
  public AvailabilityZoneCleanerTriggerBuilder(
    ...
    this.availabilityZoneExpirationAgeMillis = availabilityZoneExpirationAge;
  }
  ...
  private String buildStartState() {
    ...
    state.availabilityZoneExpirationAgeInMicros = this.availabilityZoneExpirationAgeMillis * 1000;
