...
/**
 * Tests for {@link com.vmware.photon.controller.cloudstore.xenon.task.trigger.IpLeaseCleanerTriggerBuilder}.
 */
public class IpLeaseCleanerTriggerBuilderTest {
  IpLeaseCleanerTriggerBuilder builder;
  ...
  public class BuildTest {
    ...
    private void setUp() {
      ...
      builder = new IpLeaseCleanerTriggerBuilder(triggerInterval, taskExpirationAge);
    }
    ...
    public void testSuccess() throws Throwable {
      ...
      assertThat(state.triggerStateClassName, is(IpLeaseCleanerService.State.class.getName()));
      assertThat(state.factoryServiceLink, Matchers.is(IpLeaseCleanerService.FACTORY_LINK));
    }
  }
}
