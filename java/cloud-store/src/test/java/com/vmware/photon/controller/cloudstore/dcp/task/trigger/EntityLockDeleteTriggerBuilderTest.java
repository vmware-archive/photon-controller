...
import com.vmware.photon.controller.cloudstore.dcp.task.EntityLockDeleteService;
...
/**
 * Tests for {@link com.vmware.photon.controller.cloudstore.dcp.task.trigger.EntityLockDeleteTriggerBuilder}.
 */
public class EntityLockDeleteTriggerBuilderTest {
  EntityLockDeleteTriggerBuilder builder;
  ...
  public class BuildTest {
    ...
    private void setUp() {
      ...
      builder = new EntityLockDeleteTriggerBuilder(triggerInterval, taskExpirationAge);
    }
    ...
    public void testSuccess() throws Throwable {
      ...
      assertThat(state.triggerStateClassName, is(EntityLockDeleteService.State.class.getName()));
      assertThat(state.factoryServiceLink, Matchers.is(EntityLockDeleteFactoryService.SELF_LINK));
    }
  }
}
