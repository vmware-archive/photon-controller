 ...
 */
public class EntityLockDeleteFactoryServiceTest {

  private EntityLockDeleteFactoryService factory;
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      factory = new EntityLockDeleteFactoryService();
    }
  ...
  /**
   * Tests {@link com.vmware.photon.controller.cloudstore.dcp.task.EntityLockCleanerFactoryService
  ...
  public class CreateServiceInstanceTest {
    ...
    void testSuccess() throws Throwable {
      ...
      assertThat(service, instanceOf(EntityLockDeleteService.class));
    }
  }
}
