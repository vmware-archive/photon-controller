...
/**
 * Class ImageCoordinatorService implements a service to propagate an image available on a single data store to all
 ...
 * supported.
 */
public class ImageCoordinatorService extends StatefulService {
  /**
   ...
   * Default constructor.
   */
  public ImageCoordinatorService() {
    super(State.class);
  ...
  protected void handleTriggerCopies(final State current) {
    ...
    if (!current.isSelfProgressionDisabled) {
      State patch = ImageCoordinatorService.this.buildPatch(
