...
/**
 * Tests {@link com.vmware.photon.controller.housekeeper.dcp.ImageCoordinatorService}.
 */
public class ImageCoordinatorServiceTest {

  private TestHost host;
  private ImageCoordinatorService service;
  ...
  private ImageCoordinatorService.State buildValidStartupState() {
    ImageCoordinatorService.State state = new ImageCoordinatorService.State();
  ...
  private ImageCoordinatorService.State buildValidStartupState(
      ...
      ImageCoordinatorService.TaskState.SubStage subStage) {
    ImageCoordinatorService.State state = buildValidStartupState();
    state.taskInfo = new ImageCoordinatorService.TaskState();
  ...
  private ImageCoordinatorService.State buildValidStartupState(TaskState.TaskStage stage) {
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      service = new ImageCoordinatorService();
    }
  ...
  public class HandleStartTest {
    ...
    @BeforeMethod
    public void setUp() throws Throwable {
      service = spy(new ImageCoordinatorService());
    ...
    public void testMinimalStartState() throws Throwable {
      ImageCoordinatorService.State startState = buildValidStartupState();
      startState.queryPollDelay = null;

      Operation startOp = host.startServiceSynchronously(service, startState);
      assertThat(startOp.getStatusCode(), is(200));

      ImageCoordinatorService.State savedState = host.getServiceState(ImageCoordinatorService.State.class);
      assertThat(savedState.taskInfo, notNullValue());
      assertThat(savedState.taskInfo.stage, is(TaskState.TaskStage.STARTED));
      assertThat(savedState.taskInfo.subStage, is(ImageCoordinatorService.TaskState.SubStage.TRIGGER_COPIES));
    ...
    /**
     * This test verifies that the task state of a ImageCoordinatorService instance transitions from CREATED to
    ...
    public void testCreatedStartStage() throws Throwable {
      ImageCoordinatorService.State startState =
    ...
    /**
     * This test verifies that the task state of a ImageCoordinatorService instance is not modified
     * on startup.
     *
     * @param stage
     * @param subStage
    ...
    public void testStartStateIsNotChanged(
        TaskState.TaskStage stage,
        ImageCoordinatorService.TaskState.SubStage subStage) throws Throwable {
      ImageCoordinatorService.State startState = buildValidStartupState(stage, subStage);

      Operation startOp = host.startServiceSynchronously(service, startState);
      assertThat(startOp.getStatusCode(), is(200));

      ImageCoordinatorService.State savedState =
          host.getServiceState(ImageCoordinatorService.State.class);
    ...
    public Object[][] getStartStateIsNotChangedData() {
      return new Object[][]{
          {TaskState.TaskStage.STARTED,
              ImageCoordinatorService.TaskState.SubStage.TRIGGER_COPIES},
          {TaskState.TaskStage.STARTED,
              ImageCoordinatorService.TaskState.SubStage.AWAIT_COMPLETION},
    ...
    public void testMissingSubstage() throws Throwable {
      ImageCoordinatorService.State state = buildValidStartupState(TaskState.TaskStage.STARTED);
  ...
  public class HandlePatchTest {
    ...
    public void testInvalidPatchUpdateImageField() throws Throwable {
      ...
      ImageCoordinatorService.State patchState = new ImageCoordinatorService.State();
    ...
    public void testValidStageUpdates(
        ...
        final ImageCoordinatorService.TaskState.SubStage startSubStage,
        final TaskState.TaskStage targetStage,
        final ImageCoordinatorService.TaskState.SubStage targetSubStage
    ) throws Throwable {
      ImageCoordinatorService.State startState = buildValidStartupState(startStage, startSubStage);
      host.startServiceSynchronously(service, startState);

      ImageCoordinatorService.State patchState = new ImageCoordinatorService.State();
      patchState.taskInfo = new ImageCoordinatorService.TaskState();
