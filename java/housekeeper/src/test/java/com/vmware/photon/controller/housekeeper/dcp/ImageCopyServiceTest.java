...
public class
  ...
  private ImageCopyService.State buildValidStartupState(
    ...
    state.host = "host";
    state.imageDatastores = new ArrayList<>();
    state.imageDatastores.add("image-datastore-1");
  ...
  public class HandleStartTest {
    ...
    public Object[][] getTargetStages() {
      return new Object[][]{
          {TaskState.TaskStage.STARTED, ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES},
          {TaskState.TaskStage.STARTED, ImageCopyService.TaskState.SubStage.UPDATE_HOST},
  ...
  public class HandlePatchTest {
    ...
    public void testIgnoreDuplicatedSchedulerPatch() throws Throwable {
      host.startServiceSynchronously(service, buildValidStartupState(TaskState.TaskStage.STARTED,
          ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES));
      ...
      patchState.taskInfo.subStage = ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES;
      ...
      assertThat(savedState.taskInfo.subStage, is(ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES));
    }
    ...
    public Object[][] getValidStageUpdatesData() throws Throwable {
      return new Object[][]{
          {ImageCopyService.TaskState.TaskStage.STARTED,
              ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES,
              ImageCopyService.TaskState.TaskStage.STARTED,
              ImageCopyService.TaskState.SubStage.UPDATE_HOST},
          {ImageCopyService.TaskState.TaskStage.STARTED,
              ImageCopyService.TaskState.SubStage.UPDATE_SOURCE_IMAGE_DATASTORES,
  ...
  public class EndToEndTest {
    ...
    public void testSuccess(int hostCount, CopyImageResultCode code) throws Throwable {
      ...
      createImageReplicationService(copyTask.image);
    ...
    /**
     * Test fail when no image datastore has the image.
     *
     * @throws Throwable
     */
    @Test(dataProvider = "hostCount")
    public void testFailWithoutImageDatastore(int hostCount) throws Throwable {
      doReturn(new HostClientMock()).when(hostClientFactory).create();
