...
public class
  ...
  public class HandleStartTest {
    ...
    public Object[][] getTargetStages() {
      return new Object[][]{
          {TaskState.TaskStage.STARTED, ImageCopyService.TaskState.SubStage.RETRIEVE_SOURCE_IMAGE_DATASTORES},
  ...
  public class HandlePatchTest {
    ...
    public void testIgnoreDuplicatedSchedulerPatch() throws Throwable {
      host.startServiceSynchronously(service, buildValidStartupState(TaskState.TaskStage.STARTED,
          ImageCopyService.TaskState.SubStage.RETRIEVE_SOURCE_IMAGE_DATASTORES));
      ...
      patchState.taskInfo.subStage = ImageCopyService.TaskState.SubStage.RETRIEVE_SOURCE_IMAGE_DATASTORES;
      ...
      assertThat(savedState.taskInfo.subStage, is(ImageCopyService.TaskState.SubStage.RETRIEVE_SOURCE_IMAGE_DATASTORES));
    }
