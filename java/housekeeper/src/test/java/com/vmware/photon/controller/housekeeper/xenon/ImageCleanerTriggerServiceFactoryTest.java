...
/**
 * Test {@link ImageCleanerTriggerServiceFactory}.
 */
public class ImageCleanerTriggerServiceFactoryTest {

  private ImageCleanerTriggerServiceFactory factory;
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      factory = new ImageCleanerTriggerServiceFactory();
    }
  ...
  public class CreateServiceInstanceTest {
    ...
    void testSuccess() throws Throwable {
      ...
      assertThat(service, instanceOf(ImageCleanerTriggerService.class));
    }
  }
}
