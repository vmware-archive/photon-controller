...
/**
 * Tests {@link ImageDeleteServiceFactory}.
 */
public class ImageDeleteServiceFactoryTest {

  private ImageDeleteServiceFactory factory;
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      factory = new ImageDeleteServiceFactory();
    }
  ...
  public class CreateServiceInstanceTest {
    ...
    void testSuccess() throws Throwable {
      ...
      assertThat(service, instanceOf(ImageDeleteService.class));
    }
  }
}
