...
public class HostClientTest {
  ...
  public class FindDiskTest {
    ...
    private Answer getAnswer(final Host.AsyncClient.find_call findCall) {
      return new Answer() {
        @Override
        public Object answer(InvocationOnMock invocation) throws Throwable {
          Object[] args = invocation.getArguments();
          AsyncMethodCallback<Host.AsyncClient.find_call> handler = (AsyncMethodCallback) args[1];
          handler.onComplete(findCall);
          return null;
        }
      };
    }
    ...
    public void testSuccess() throws Exception {
      ...
      final Host.AsyncClient.find_call findCall = mock(Host.AsyncClient.find_call.class);
      doReturn(findResponse).when(findCall).getResult();
      doAnswer(getAnswer(findCall))
          .when(clientProxy).find(any(FindRequest.class), any(AsyncMethodCallback.class));

      hostClient.setClientProxy(clientProxy);
      assertThat(hostClient.findDisk(diskId), is(true));
    }

    @Test
    public void testFailureDiskNotFound() throws Exception {
      FindResponse findResponse = new FindResponse();
      findResponse.setResult(FindResultCode.NOT_FOUND);
      final Host.AsyncClient.find_call findCall = mock(Host.AsyncClient.find_call.class);
      doReturn(findResponse).when(findCall).getResult();
      doAnswer(getAnswer(findCall))
          .when(clientProxy).find(any(FindRequest.class), any(AsyncMethodCallback.class));
      ...
      hostClient.setClientProxy(clientProxy);
      assertThat(hostClient.findDisk(diskId), is(false));
    }

    @Test
    public void testFailureNullHostIp() throws Exception {
      try {
        hostClient.findDisk(diskId);
        fail("Synchronous findDisk call should throw with null async clientProxy");
      } catch (IllegalArgumentException e) {
        assertThat(e.toString(), is("java.lang.IllegalArgumentException: hostname can't be null"));
      }
    }
    ...
    public void testFailureTExceptionOnCall() throws Exception {
      ...
      try {
        hostClient.findDisk(diskId);
        fail("Synchronous findDisk call should convert TException on call to RpcException");
      } catch (RpcException e) {
        assertThat(e.getMessage(), is("Thrift exception"));
      }
    }
    ...
    public void testFailureTExceptionOnGetResult() throws Exception {
      final Host.AsyncClient.find_call findCall = mock(Host.AsyncClient.find_call.class);
      doThrow(new TException("Thrift exception")).when(findCall).getResult();
      doAnswer(getAnswer(findCall))
          .when(clientProxy).find(any(FindRequest.class), any(AsyncMethodCallback.class));
    ...
    @Test(dataProvider = "FindDiskFailureResultCodes")
    public void testFailureResult(FindResultCode resultCode,
                                  Class<RuntimeException> exceptionClass) throws Exception {
      FindResponse findResponse = new FindResponse();
      findResponse.setResult(resultCode);
      findResponse.setError(resultCode.toString());
      ...
      try {
        hostClient.findDisk(diskId);
        fail("Synchronous findDisk call should throw on failure result: " + resultCode.toString());
      } catch (Exception e) {
        assertTrue(e.getClass() == exceptionClass);
        assertThat(e.getMessage(), is(resultCode.toString()));
      }
    ...
    @DataProvider(name = "FindDiskFailureResultCodes")
    public Object[][] getFindDiskFailureResultCodes() {
      return new Object[][]{
          {FindResultCode.SYSTEM_ERROR, SystemErrorException.class},
      };
    }
  ...
  /**
   * Tests for the findVm method.
   */
  public class FindVmTest {

    private String vmId = "diskId";
    ...
    public void testSuccess() throws Exception {
      ...
      hostClient.setClientProxy(clientProxy);
      assertThat(hostClient.findVm(vmId), is(true));
    }

    @Test
    public void testFailureVmNotFound() throws Exception {
      FindResponse findResponse = new FindResponse();
      findResponse.setResult(FindResultCode.NOT_FOUND);
      final Host.AsyncClient.find_call findCall = mock(Host.AsyncClient.find_call.class);
      doReturn(findResponse).when(findCall).getResult();
      ...
      hostClient.setClientProxy(clientProxy);
      assertThat(hostClient.findVm(vmId), is(false));
    }

    @Test
    public void testFailureNullHostIp() throws Exception {
      try {
        hostClient.findVm(vmId);
        fail("Synchronous findVm call should throw with null async clientProxy");
      } catch (IllegalArgumentException e) {
        assertThat(e.toString(), is("java.lang.IllegalArgumentException: hostname can't be null"));
      }
    }
    ...
    public void testFailureTExceptionOnCall() throws Exception {
      ...
      try {
        hostClient.findVm(vmId);
        fail("Synchronous findVm call should convert TException on call to RpcException");
      } catch (RpcException e) {
        assertThat(e.getMessage(), is("Thrift exception"));
      }
    }
    ...
    @Test(dataProvider = "FindVmFailureResultCodes")
    public void testFailureResult(FindResultCode resultCode,
                                  Class<RuntimeException> exceptionClass) throws Exception {
      FindResponse findResponse = new FindResponse();
      findResponse.setResult(resultCode);
      ...
      try {
        hostClient.findVm(vmId);
        fail("Synchronous findVm call should throw on failure result: " + resultCode.toString());
      } catch (Exception e) {
        assertTrue(e.getClass() == exceptionClass);
        assertThat(e.getMessage(), is(resultCode.toString()));
      }
    ...
    @DataProvider(name = "FindVmFailureResultCodes")
    public Object[][] getFindVmFailureResultCodes() {
      return new Object[][]{
          {FindResultCode.SYSTEM_ERROR, SystemErrorException.class},
      };
    }
  ...
  /**
   * Tests for the getImageInfo method.
   */
  public class GetImageInfoTest {
    ...
    private Answer getAnswer(final Host.AsyncClient.get_image_info_call getImageInfoCall) {
      return new Answer() {
        @Override
        public Object answer(InvocationOnMock invocation) throws Throwable {
          Object[] args = invocation.getArguments();
          AsyncMethodCallback<Host.AsyncClient.get_image_info_call> handler = (AsyncMethodCallback) args[1];
          handler.onComplete(getImageInfoCall);
          return null;
        }
      };
    }
    ...
    public void testSuccess() throws Exception {
      ...
      imageInfoResponse.setResult(ImageInfoResultCode.OK);
      final Host.AsyncClient.get_image_info_call getImageInfoCall = mock(Host.AsyncClient.get_image_info_call.class);
      doReturn(imageInfoResponse).when(getImageInfoCall).getResult();


      doAnswer(getAnswer(getImageInfoCall))
          .when(clientProxy).get_image_info(any(ImageInfoRequest.class), any(AsyncMethodCallback.class));

      hostClient.setClientProxy(clientProxy);
      assertThat(hostClient.getImageInfo(imageId, dataStoreId), is(imageInfoResponse));
    }

    @Test
    public void testFailureNullHostIp() throws Exception {
      try {
        hostClient.getImageInfo(imageId, dataStoreId);
        fail("Synchronous getImageInfo call should throw with null async clientProxy");
      } catch (IllegalArgumentException e) {
        assertThat(e.toString(), is("java.lang.IllegalArgumentException: hostname can't be null"));
      }
    }
    ...
    public void testFailureTExceptionOnCall() throws Exception {
      ...
      try {
        hostClient.getImageInfo(imageId, dataStoreId);
        fail("Synchronous getImageInfo call should convert TException on call to RpcException");
      } catch (RpcException e) {
        assertThat(e.getMessage(), is("Thrift exception"));
      }
    }
    ...
    public void testFailureTExceptionOnGetResult() throws Exception {
      final Host.AsyncClient.get_image_info_call getImageInfoCall = mock(Host.AsyncClient.get_image_info_call.class);
      doThrow(new TException("Thrift exception")).when(getImageInfoCall).getResult();
      doAnswer(getAnswer(getImageInfoCall))
          .when(clientProxy).get_image_info(any(ImageInfoRequest.class), any(AsyncMethodCallback.class));
    ...
    @Test(dataProvider = "GetImageInfoFailureResultCodes")
    public void testFailureResult(ImageInfoResultCode resultCode,
                                  Class<RuntimeException> exceptionClass) throws Exception {
      ImageInfoResponse imageInfoResponse = new ImageInfoResponse();
      imageInfoResponse.setResult(resultCode);
      imageInfoResponse.setError(resultCode.toString());
      ...
      try {
        hostClient.getImageInfo(imageId, dataStoreId);
        fail("Synchronous getImageInfo call should throw on failure result: " + resultCode.toString());
      } catch (Exception e) {
        assertTrue(e.getClass() == exceptionClass);
        assertThat(e.getMessage(), is(resultCode.toString()));
      }
    ...
    @DataProvider(name = "GetImageInfoFailureResultCodes")
    public Object[][] getGetImageInfoFailureResultCodes() {
      return new Object[][]{
          {ImageInfoResultCode.DATASTORE_NOT_FOUND, DatastoreNotFoundException.class},
          {ImageInfoResultCode.IMAGE_NOT_FOUND, ImageNotFoundException.class},
          {ImageInfoResultCode.INVALID_REF_COUNT_FILE, ImageRefCountFileException.class},
          {ImageInfoResultCode.SYSTEM_ERROR, SystemErrorException.class},
      };
    }
