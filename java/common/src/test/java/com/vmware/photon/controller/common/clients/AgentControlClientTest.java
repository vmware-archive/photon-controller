...
public class AgentControlClientTest {
  ...
  private void setUpWithGuiceInjection() {
    ...
    agentControlClient.setServerSetFactory(zookeeperServerSetFactory);
  }
  ...
  public class EnsureClientTest {
    ...
    public void testSetClientProxyWithAgentId() throws Throwable {
      agentControlClient.setAgentId(agentId);
      agentControlClient.ensureClient();

      verify(zookeeperServerSetFactory).createHostServerSet(agentId);
      assertThat(agentControlClient.getClientProxy(), notNullValue());
      assertThat(agentControlClient.getAgentId(), is(agentId));
      assertThat(agentControlClient.getHostIp(), nullValue());
      assertThat(agentControlClient.getPort(), is(0));
    }
    ...
    public void testSetClientProxyWithIpAndPort() throws Throwable {
      ...
      agentControlClient.ensureClient();
      assertThat(agentControlClient.getClientProxy(), notNullValue());
      assertThat(agentControlClient.getAgentId(), nullValue());
  ...
  /**
   * This class implements tests for method {@link AgentControlClient#getHostIp()} getHostIp}.
   */
  public class GetHostIpTest {
    ...
    public void testNullAgentId() {
      agentControlClient.setHostIp("127.0.0.1");
      assertThat(agentControlClient.getAgentId(), nullValue());
      assertThat(agentControlClient.getHostIp(), is("127.0.0.1"));
    }
