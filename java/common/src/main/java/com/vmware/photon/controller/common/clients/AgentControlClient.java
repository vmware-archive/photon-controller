 ...
 * <p>
 * Note that this class is not thread safe, because thrift's .AsyncSSLClient.is not thread
 ...
 * shares global .AsyncSSLClient.anager and ClientProxyExecutor, so it is fairly
