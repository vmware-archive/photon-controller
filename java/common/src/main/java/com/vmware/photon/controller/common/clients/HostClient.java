...
public class HostClient {
  ...
  public void setAvailabilityZone(String availabilityZone,
                                  AsyncMethodCallback<Host.AsyncClient.set_availability_zone_call> handler)
      throws RpcException {
    ensureClient();

    SetAvailabilityZoneRequest setAvailabilityZoneRequest = new SetAvailabilityZoneRequest();
  ...
  /**
   * This method performs a synchronous Thrift call to set availability zone of host.
   *
   * @param availabilityZone
   * @return On success, the return code is the SetAvailabilityZoneResponse object
   * generated by the Thrift call.
   * @throws InterruptedException
   * @throws RpcException
   */
  @RpcMethod
  public SetAvailabilityZoneResponse setAvailabilityZone(String availabilityZone)
      throws InterruptedException, RpcException {
    SyncHandler<SetAvailabilityZoneResponse, Host.AsyncClient.set_availability_zone_call> syncHandler =
        new SyncHandler<>();
    setAvailabilityZone(availabilityZone, syncHandler);
    syncHandler.await();
    return ResponseValidator.checkSetAvailabilityZoneResponse(syncHandler.getResponse());
  }
  ...
  public static class ResponseValidator {
    ...
    /**
     * This method validates a SetAvailabilityZoneResponse object, raising an exception if
     * the response reflects an operation failure.
     *
     * @param setAvailabilityZoneResponse Supplies a SetAvailabilityZoneResponse object generated by
     *                          a setAvailabilityZone call.
     * @return On success, the return value is the SetAvailabilityZoneResponse object
     * specified as a parameter.
     * @throws RpcException
     */
    public static SetAvailabilityZoneResponse checkSetAvailabilityZoneResponse(
        SetAvailabilityZoneResponse setAvailabilityZoneResponse)
        throws RpcException {
      logger.info("Checking {}", setAvailabilityZoneResponse);
      switch (setAvailabilityZoneResponse.getResult()) {
        case OK:
          break;
        case SYSTEM_ERROR:
          throw new SystemErrorException(setAvailabilityZoneResponse.getError());
        default:
          throw new RpcException(String.format("Unknown result: %s", setAvailabilityZoneResponse.getResult()));
      }
