...
public class XenonRestClient implements XenonClient {
  ...
  // Both start and stop were used for controlling a client
  // We start the serviceHost elsewhere and do not stop the serviceHost
  // as it would stop all the Xenon services.
  @Override
  public void start() {
