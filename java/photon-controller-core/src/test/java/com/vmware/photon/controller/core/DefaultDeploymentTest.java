...
public class DefaultDeploymentTest {
  ...
  public void testDefaultDeploymentGetsCreated() throws Throwable {
    ...
    DeploymentService.State savedState;
    savedState = ServiceHostUtils.getServiceState(testEnvironment.getHosts()[0],  DeploymentService.State.class,
        selfLink, "test-host");
    assertThat(savedState, notNullValue());
    savedState = ServiceHostUtils.getServiceState(testEnvironment.getHosts()[1],  DeploymentService.State.class,
        selfLink, "test-host");
    assertThat(savedState, notNullValue());
    savedState = ServiceHostUtils.getServiceState(testEnvironment.getHosts()[2],  DeploymentService.State.class,
        selfLink, "test-host");
    assertThat(savedState, notNullValue());
  }
}
