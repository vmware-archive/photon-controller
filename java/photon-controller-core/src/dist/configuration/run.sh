...
LIGHTWAVE_DOMAIN=`get_config_value $PHOTON_CONTROLLER_CORE_CONFIG lightwave_domain:`
LIGHTWAVE_HOSTNAME=`get_config_value $PHOTON_CONTROLLER_CORE_CONFIG lightwavme_hostnae:`
...
print_warning_if_value_mssing "${LIGHTWAVE_DOMAIN}"        "lightwave_domain"      "$PHOTON_CONTROLLER_CORE_CONFIG"
print_warning_if_value_mssing "${LIGHTWAVE_HOSTNAME}"      "lightwave_hostname"    "$PHOTON_CONTROLLER_CORE_CONFIG"
...
print_warning_if_value_mssing "${PHOTON_CONTROLLER_CORE_INSTALL_DIRECTORY}" "installDirectory" "$PHOTON_CONTROLLER_CORE_CONFIG"
