...
public class L4PortSetNSService extends NSServiceElement {
  ...
  @Size(max = 15)
  private List<PortElement> sourcePorts;

  @JsonProperty(value = "destination_ports", required = false)
  @Size(max = 15)
  private List<PortElement> destinationPorts;
  ...
  public List<PortElement> getSourcePorts() {
    return this.sourcePorts;
  }

  public void setSourcePorts(List<PortElement> sourcePorts) {
    this.sourcePorts = sourcePorts;
  }

  public List<PortElement> getDestinationPorts() {
    return this.destinationPorts;
  }

  public void setDestinationPorts(List<PortElement> destinationPorts) {
