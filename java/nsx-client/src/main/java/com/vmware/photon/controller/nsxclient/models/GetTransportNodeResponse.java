...
/**
 * This class represents a GetTransportNodeResponse JSON structure.
 */
@JsonIgnoreProperties(ignoreUnknown =  true)
public class GetTransportNodeResponse {
  ...
  public boolean equals(Object o) {
    ...
    GetTransportNodeResponse other = (GetTransportNodeResponse) o;
