...
/**
 * Represent the created downlink port on a logical router.
 */
public class LogicalRouterDownLinkPort {
  ...
  public boolean equals(Object o) {
    ...
    LogicalRouterDownLinkPort other = (LogicalRouterDownLinkPort) o;
