...
/**
 * This class represents a CreateTransportZoneResponse JSON structure.
 */
@JsonIgnoreProperties(ignoreUnknown =  true)
public class CreateTransportZoneResponse {
  ...
  public boolean equals(Object o) {
    ...
    CreateTransportZoneResponse other = (CreateTransportZoneResponse) o;
