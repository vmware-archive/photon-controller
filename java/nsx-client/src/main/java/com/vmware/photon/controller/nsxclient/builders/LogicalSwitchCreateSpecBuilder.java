...
public class LogicalSwitchCreateSpecBuilder {
  ...
  public LogicalSwitchCreateSpecBuilder replicationMode(LogicalSwitch.ReplicationMode replicationMode) {
    this.replicationMode = replicationMode;
    return this;
  }

  public LogicalSwitchCreateSpecBuilder adminState(LogicalSwitch.AdminState adminState) {
