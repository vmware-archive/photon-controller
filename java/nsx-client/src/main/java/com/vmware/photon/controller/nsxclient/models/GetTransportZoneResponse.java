...
/**
 * This class represents a GetTransportZoneResponse JSON structure.
 */
@JsonIgnoreProperties(ignoreUnknown =  true)
public class GetTransportZoneResponse {
  ...
  public boolean equals(Object o) {
    ...
    GetTransportZoneResponse other = (GetTransportZoneResponse) o;
