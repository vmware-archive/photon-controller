...
import com.vmware.photon.controller.nsxclient.models.NsxLogicalSwitch;
...
public class LogicalSwitchApiTest {
   ...
   */
  public static class LogicalSwitchCreateTest {
    ...
    public void testSuccessfullyCreated() throws Exception {
      LogicalSwitchCreateSpec spec = new LogicalSwitchCreateSpecBuilder()
          ...
          .displayName("switch1")
          .build();
      NsxLogicalSwitch logicalSwitch = new NsxLogicalSwitch();
      ...
      NsxLogicalSwitch createdLogicalSwitch = logicalSwitchApi.createLogicalSwitch(spec);
