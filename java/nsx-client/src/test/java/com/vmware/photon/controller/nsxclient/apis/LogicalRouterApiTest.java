    ...
    public void testSuccessfullyCreatedNatRule() throws Exception {
      ...
      doAnswer(invocation -> {
        ...
        return null;
          ...
          .postAsync(eq(logicalRouterApi.logicalRouterBasePath + "/" + routerId + "/nat/rules"),
              any(HttpEntity.class),
              eq(HttpStatus.SC_CREATED),
              any(TypeReference.class),
              any(FutureCallback.class));
    ...
    public void testSuccessfullyGetNatRule() throws Exception {
      ...
      doAnswer(invocation -> {
        ...
        return null;
          ...
          .getAsync(eq(logicalRouterApi.logicalRouterBasePath + "/" + routerId + "/nat/rules/" + ruleId),
              eq(HttpStatus.SC_OK),
              any(TypeReference.class),
              any(FutureCallback.class));
    ...
    public void testSuccessfullyDeleteNatRule() throws Exception {
      doAnswer(invocation -> {
        ...
        return null;
          ...
          .deleteAsync(eq(logicalRouterApi.logicalRouterBasePath + "/" + routerId + "/nat/rules/" + ruleId),
              eq(HttpStatus.SC_OK),
              any(FutureCallback.class));
