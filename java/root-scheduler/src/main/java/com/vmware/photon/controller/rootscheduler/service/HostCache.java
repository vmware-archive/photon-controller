...
public class HostCache {
  ...
  protected ConcurrentMultiMap<String, String> datastoreTagsToDatatores;
   ...
   * Intended for testing
   */
  public int getManagementHostCount() {
  ...
  public Set<String> getHostsWithDatastoreTag(String datastoreTag) {
    ...
    for (String datastoreId : this.datastoreTagsToDatatores.getValues(datastoreTag)) {
  ...
  private void initializeCache() {
    ...
    datastoreTagsToDatatores = new ConcurrentMultiMap<>();
  }
  ...
  private void addOrUpdateDatastore(DatastoreService.State datastore) {
    ...
    if (datastore.tags != null) {
      for (String tag : datastore.tags) {
        this.datastoreTagsToDatatores.addOrUpdate(tag, datastoreId);
      }
    }
  }
  ...
  private void deleteDatastore(DatastoreService.State datastore) {
    ...
    this.datastoreTagsToDatatores.removeFromAll(datastoreId);
