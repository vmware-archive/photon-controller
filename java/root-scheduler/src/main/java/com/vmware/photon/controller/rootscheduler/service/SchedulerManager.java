...
public class SchedulerManager {
  ...
  public PlaceResponse place(PlaceRequest request) throws InterruptedException {
    ...
    logger.info("elapsed-time root-get-schedulers {} milliseconds",
        getSchedulersStopwatch.elapsed(TimeUnit.MILLISECONDS));
    ...
    logger.info("elapsed-time root-get-placements {} milliseconds",
        getPlacementsStopwatch.elapsed(TimeUnit.MILLISECONDS));
