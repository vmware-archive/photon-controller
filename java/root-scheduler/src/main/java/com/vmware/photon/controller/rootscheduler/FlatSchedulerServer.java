...
/**
 * Flat scheduler server.
 */
public class FlatSchedulerServer {
  private static final Logger logger = LoggerFactory.getLogger(FlatSchedulerServer.class);
  ...
  @Inject
  public FlatSchedulerServer(@Config.Bind String bind,
