 ...
 */
public class PlacementTaskFactoryService extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.SCHEDULER_ROOT + "/placement";

  public PlacementTaskFactoryService() {
    super(PlacementTask.class);
  }

  public Service createServiceInstance() {
    return new PlacementTaskService();
  }
}
