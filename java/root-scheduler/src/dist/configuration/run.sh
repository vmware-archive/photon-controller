...
ROOT_SCHEDULER_BIN="{{{ROOT-SCHEDULER_INSTALL_DIRECTORY}}}/bin"
ROOT_SCHEDULER_CONFIG="/etc/esxcloud/root-scheduler.yml"
...
# Start service
#
$ROOT_SCHEDULER_BIN/root-scheduler $ROOT_SCHEDULER_CONFIG
