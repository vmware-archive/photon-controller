...
public class CloudStoreConstraintCheckerTest {
   ...
   *
   * Note that when we create a host, due to symmetric replication the host created is not immediately available
   * when we do a local query. This test makes sure that we do it repeatedly till we find it.
   */
