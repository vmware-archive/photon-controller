...
import com.vmware.photon.controller.rootscheduler.RootSchedulerDcpHost;
...
public class TestRootSchedulerModule extends AbstractModule {
  ...
  @Provides
  @Singleton
  public RootSchedulerDcpHost createServer(
      @Config.Bind String bind,
      @Config.Port int port,
      @Config.StoragePath String storagePath) throws Throwable {
    return spy(new RootSchedulerDcpHost(bind, port, storagePath));
  }
}
