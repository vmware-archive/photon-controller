...
public class ConstraintCheckerTest {
  ...
  public void testNoConstraint(ConstraintChecker checker) {
    ...
    // times and verifying that everybody gets picked. This is not deterministic.
    logger.info("Testing 10,000 times that {} can find 1 candidate...", checker.getClass().getSimpleName());
