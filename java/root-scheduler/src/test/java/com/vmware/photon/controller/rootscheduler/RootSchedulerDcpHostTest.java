...
/**
 * This class implements tests for the {@link RootSchedulerDcpHost} class.
 */
public class RootSchedulerDcpHostTest {
  ...
  private RootSchedulerDcpHost host;
  private Collection<String> serviceSelfLinks;

  private void waitForServicesStartup(RootSchedulerDcpHost host)
    ...
    serviceSelfLinks = ServiceHostUtils.getServiceSelfLinks(
        RootSchedulerDcpHost.FACTORY_SERVICE_FIELD_NAME_SELF_LINK,
        RootSchedulerDcpHost.FACTORY_SERVICES);
  ...
  public class InitializationTest {
    ...
    public void testStoragePathExists() throws IOException {
      ...
      RootSchedulerDcpHost host = injector.getInstance(RootSchedulerDcpHost.class);
  ...
  public class StartTest {
    ...
    private void setUp() throws Throwable {
      injector = TestHelper.createInjector(configFilePath);
      host = injector.getInstance(RootSchedulerDcpHost.class);
    }
  ...
  public class JoinNodeGroupTest {
    ...
    private RootSchedulerDcpHost host2;
    ...
    private void setUp() throws Throwable {
      ...
      host2 = new RootSchedulerDcpHost(
    ...
    public void testJoinNodeGroup() throws Throwable {
      ...
      ServiceHostUtils.waitForNodeGroupConvergence(
          new RootSchedulerDcpHost[]{host, host2},
