...
public class NetworkService extends StatefulService {
  ...
  public static class NetworkState extends ServiceDocument {
     ...
     */
    public URI networkServiceAdapter;
  ...
  public static void validateState(NetworkState state) {
    ...
    if (state.networkServiceAdapter == null) {
  ...
  public void handlePatch(Operation patch) {
    ...
    if (patchBody.networkServiceAdapter != null
              && !patchBody.networkServiceAdapter.equals(
                                 currentState.networkServiceAdapter)) {
      currentState.networkServiceAdapter = patchBody.networkServiceAdapter;
      isChanged = true;
    }
