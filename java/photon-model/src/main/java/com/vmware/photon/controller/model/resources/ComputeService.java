...
import com.vmware.photon.controller.model.requests.ComputeHealthRequest;
import com.vmware.photon.controller.model.requests.ComputeHealthResponse;
...
public class ComputeService extends StatefulService {
  ...
  public void handleGet(Operation get) {
    ...
    Operation getDesc = Operation.createGet(this, currentState.descriptionLink).setCompletion(
        (o, e) -> {
          if (e != null) {
            get.fail(e);
            return;
  ...
  private void completeStart(Operation start) {
    try {
      ...
      Operation getDesc = Operation.createGet(this, s.descriptionLink).setCompletion(
          (o, e) -> {
            if (e != null) {
              start.fail(e);
              return;
  ...
  public void handlePatch(Operation patch) {
    ...
    if (patchBody.powerState != null && patchBody.powerState != currentState.powerState) {
