...
public class ComputeServiceTest {
  ...
  private static ComputeDescriptionService.ComputeDescription createComputeDescription(TestHost host) throws Throwable {
    return host.postServiceSynchronously(
        ComputeDescriptionFactoryService.SELF_LINK,
        ComputeDescriptionServiceTest.buildValidStartState(),
