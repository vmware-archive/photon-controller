...
public class SnapshotFactoryServiceTest {
  ...
  public void setUpTest() {
    snapshotFactoryService = new SnapshotFactoryService();
  }
  ...
  public void testServiceOptions() {
    ...
    assertThat(snapshotFactoryService.getOptions(), is(expected));
  }

  @Test
  public void testCreateServiceInstance() throws Throwable {
    Service service = snapshotFactoryService.createServiceInstance();
