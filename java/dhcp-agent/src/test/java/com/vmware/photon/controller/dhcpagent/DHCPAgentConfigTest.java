...
/**
 * Tests {@link DHCPAgentConfig}.
 */
public class DHCPAgentConfigTest {
  ...
  public void setUp() throws BadConfigException {
    config = ConfigBuilder.build(DHCPAgentConfig.class,
        DHCPAgentConfigTest.class.getResource("/config.yml").getPath());
  }
