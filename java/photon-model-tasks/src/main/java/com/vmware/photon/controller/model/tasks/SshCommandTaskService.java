 ...
 * To use this service, ServiceHost must be extended to implement ExecutorServiceProvider interface.
 */
      ...
      sendRequest(Operation
          ...
          .setCompletion((o, e) -> {
            ...
            try {
              ...
              // HostService must implement ExecutorServiceProvider interface.
              ExecutorServiceProvider provider = (ExecutorServiceProvider) getHost();
              provider.getExecutorService().submit(new SshCommand(state, auth));
            } catch (Throwable t) {
              fail(state, t);
            }
          }));
