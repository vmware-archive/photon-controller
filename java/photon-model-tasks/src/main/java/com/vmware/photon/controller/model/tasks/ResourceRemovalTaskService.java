...
public class ResourceRemovalTaskService extends StatefulService {
  ...
  public ResourceRemovalTaskService() {
    ...
    // this task is not durable. It will be recreated by a logically higher level
    // service
  ...
  public void handleStart(Operation start) {
    try {
      ...
      ResourceRemovalTaskState state = getBody(start);
      validateState(state);
  ...
  public ResourceRemovalTaskState getBody(Operation op) {
  ...
  public void handlePatch(Operation patch) {
    ResourceRemovalTaskState body = getBody(patch);
