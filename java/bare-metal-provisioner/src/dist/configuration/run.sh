...
BARE_METAL_PROVISIONER_BIN="{{{BARE-METAL-PROVISIONER_INSTALL_DIRECTORY}}}/bin"
BARE_METAL_PROVISIONER_CONFIG="$CONFIG_PATH/bare-metal-provisioner.yml"
...
# Start service
#
$BARE_METAL_PROVISIONER_BIN/bare-metal-provisioner $BARE_METAL_PROVISIONER_CONFIG
