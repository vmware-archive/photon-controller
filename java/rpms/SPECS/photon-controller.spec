...
mustache %{temp_config_file} ./photon-controller-core.yml > photon-controller-core-out.yml
mustache %{temp_config_file} ./management-api.yml > management-api-out.yml
mustache %{temp_config_file} ./run.sh > run-out.sh
