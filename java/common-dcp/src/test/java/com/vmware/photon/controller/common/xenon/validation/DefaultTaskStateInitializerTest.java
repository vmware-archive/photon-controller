...
/**
 * This class implements tests for {@link DefaultTaskStateInitializer}.
 */
public class DefaultTaskStateInitializerTest {

  DefaultTaskStateInitializer initializer = DefaultTaskStateInitializer.INSTANCE;
  ...
  public void successfullySettingBoolean() {
    ...
    assertThat(doc.value, is(notNullValue()));
  }
