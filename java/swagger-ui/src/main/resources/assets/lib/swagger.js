...
(function() {
  ...
  SwaggerModelProperty = (function() {
    ...
    function SwaggerModelProperty(name, obj) {
      ...
      this.isList = this.dataType.toLowerCase() === 'list';
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.isGenericType = function(dataType) {
      if (dataType.indexOf('<') >= 0 && dataType.indexOf('>') > 0) {
        return dataType.substring(dataType.indexOf('<') + 1, dataType.indexOf('>'));
      } else {
        return void 0;
    ...
    SwaggerOperation.prototype.getSignature = function(dataType, models) {
      ...
      type = this.isListType(dataType) || this.isGenericType(dataType);
      isPrimitive = ((type != null) && models[type]) || (models[dataType] != null) ? false : true;
      if (isPrimitive) {
        return dataType;
      } else {
        if (type != null) {
          return (models[dataType] != null) ? models[dataType].getMockSignature() : models[type].getMockSignature();
        } else {
