...
/**
 * This class implements a Xenon service which provides a factory for {@link RateLimitedWorkQueueService} instances.
 */
public class RateLimitedWorkQueueFactoryService extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.SERVICES_ROOT + "/photon/work-queues";
