                  ...
                  .setCompletion((operation, throwable) -> {
                    ...
                    if (imageState.replicatedImageDatastore != null &&
                      ...
                      ServiceUtils.logInfo(this,
                        "Image link: " + imageState.documentSelfLink + "," +
                        "Replicated image datastore: " + imageState.replicatedImageDatastore + ", " +
                        "Total image datastore: " + imageState.totalImageDatastore);
