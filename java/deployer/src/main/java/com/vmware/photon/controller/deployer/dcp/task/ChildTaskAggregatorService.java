...
public class ChildTaskAggregatorService extends StatefulService {
  ...
  public static class State extends ServiceDocument {
     ...
     */
    @NotNull
    public Integer completionsRemaining;
    ...
    switch (patchState.taskState.stage) {
      ...
      case CANCELLED:
        ...
        double failureRatio = (double) currentState.failureCount / (double)
            (currentState.finishedCount + currentState.failureCount + currentState.completionsRemaining);
    ...
    if (currentState.completionsRemaining == 0) {
      ...
      sendRequest(Operation
          ...
          .setCompletion(
              (o, e) -> {
                if (e != null) {
                  ServiceUtils.logWarning(this, "Failed to notify parent task: " + Utils.toString(e));
                }
              }));

      sendRequest(Operation
          .createDelete(this, getSelfLink())
          .setBody(new ServiceDocument())
          .setCompletion(
              (o, e) -> {
                if (e != null) {
                  ServiceUtils.logWarning(this, "Failed to delete self: " + Utils.toString(e));
                }
              }));
    }
  }
