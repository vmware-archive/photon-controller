...
public class MiscUtils {
  ...
  public static int getAdjustedManagementHostMemory(HostService.State hostState) {
    float managementVmHostRatio = getManagementVmHostRatio(hostState);
    int afterRationMemeory = (int) (hostState.memoryMb * managementVmHostRatio);
    return floorToNearestNumberDivisibleByFour(afterRationMemeory);
  }

  public static int floorToNearestNumberDivisibleByFour(int number) {
    return number & ~(0x3);
  }
}
