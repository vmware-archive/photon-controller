...
public class HostUtils {
  ...
  /**
   * This function gets the agent control client from the DCP host associated with the specified service.
   *
   * @param service Supplies a DCP service instance.
   * @return The agent control client provided by the DCP host associated with the service.
   */
