...
/**
 * Class implementing service to get status of deployer.
 */
public class StatusService extends StatelessService {
  ...
  public void handleGet(Operation get) {
    ...
    BuildInfo buildInfo = ((DeployerXenonServiceHost) getHost()).getBuildInfo();
    status.setBuild_info(buildInfo.toString());

    if (((DeployerXenonServiceHost) getHost()).isReady()) {
