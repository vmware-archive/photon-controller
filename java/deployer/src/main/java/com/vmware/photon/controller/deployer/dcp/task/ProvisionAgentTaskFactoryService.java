...
/**
 * This class implements a DCP micro-service which provides a factory for {@link ProvisionAgentTaskService} instances.
 */
public class ProvisionAgentTaskFactoryService extends FactoryService {

  public static final String SELF_LINK = ServiceUriPaths.SERVICES_ROOT + "/provision-agent-tasks";
