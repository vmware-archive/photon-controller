...
public class Main {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    try {
      ...
      final DeployerXenonServiceHost deployerXenonServiceHost = createDeployerXenonServiceHost(injector, thriftModule,
...
//    final ZookeeperClientFactory zookeeperServerSetBuilderFactory = new ZookeeperClientFactoryImpl(deployerConfig);
    final ZookeeperClientFactory zookeeperServerSetBuilderFactory = injector.getInstance(ZookeeperClientFactory.class);
