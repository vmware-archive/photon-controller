...
public class DeployerDefaults {
   ...
   */
  public static final String MGMT_UI_LOGIN_REDIRECT_URL_TEMPLATE = "https://%s:4343/login_redirect.html";

  /**
   * Management UI logout redirect URL template.
   */
  public static final String MGMT_UI_LOGOUT_REDIRECT_URL_TEMPLATE = "https://%s:4343/logout_redirect.html";
   ...
   */
  public static final String SWAGGER_UI_LOGOUT_REDIRECT_URL_TEMPLATE = "https://%s/api/logout-redirect.html";
}
