  ...
  public class HandleStart {
    ...
    public Object[][] getValidStartStates() {
      return new Object[][]{
          ...
          {TaskState.TaskStage.STARTED, CreateManagementVmWorkflowService.TaskState.SubStage.CREATE_ISO},
          {TaskState.TaskStage.STARTED, CreateManagementVmWorkflowService.TaskState.SubStage.START_VM},
