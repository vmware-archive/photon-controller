...
public class ProvisionHostTaskServiceTest {
  ...
  public class HandleStartTest {
    ...
    public Object[][] getOptionalFieldNames() {
      return new Object[][]{
          {"maximumProvisionCount", new Integer(1)},
          {"provisionPollDelay", new Integer(1)},
          {"provisionCount", null},
          {"maximumAgentStatusCount", new Integer(1)},
          {"agentStatusPollDelay", new Integer(1)},
          {"agentStatusCount", null},
      };
    }
  ...
  public class ProvisionAgentTest {
    ...
    public void setUpClass() throws Throwable {
      ...
      startState.hostServiceLink = TestHelper.createHostService(cloudStoreEnvironment,
          Collections.singleton(UsageTag.MGMT.name())).documentSelfLink;
      startState.maximumProvisionCount = 3;
      startState.provisionPollDelay = 10;
    }
    ...
    @Test
    public void testProvisionAgentSuccessAfterFailures() throws Throwable {

      HostClientMock thriftExceptionMock = new HostClientMock.Builder()
          .provisionFailure(new TException("Thrift exception during provision call"))
          .build();

      HostClientMock systemErrorMock = new HostClientMock.Builder()
      ...
      when(hostClientFactory.create())
          .thenReturn(thriftExceptionMock)
          .thenReturn(systemErrorMock)
    ...
    public void testProvisionAgentFailureWithInvalidResult(ProvisionResultCode resultCode) throws Throwable {
      ...
      assertThat(finalState.taskState.failure.message, containsString(
          "Provisioning the agent on host hostAddress failed after 3 retries"));
    }
    ...
    @Test
    public void testProvisionAgentFailureWithThriftException() throws Throwable {

      HostClientMock agentNotReadyMock = new HostClientMock.Builder()
          .provisionFailure(new TException("Thrift exception while calling provision"))
          .build();
  ...
  public class WaitForAgentTest {
    ...
    public void setUpClass() throws Throwable {
      ...
      startState.hostServiceLink = TestHelper.createHostService(cloudStoreEnvironment,
          Collections.singleton(UsageTag.MGMT.name())).documentSelfLink;
      startState.maximumAgentStatusCount = 3;
      startState.agentStatusPollDelay = 10;
    }
    ...
    @Test
    public void testWaitForAgentFailureInvalidAgentConfig() throws Throwable {

      HostClientMock agentRestartingMock = new HostClientMock.Builder()
          .agentStatusCode(AgentStatusCode.RESTARTING)
          .build();

      HostClientMock invalidConfigMock = new HostClientMock.Builder()
      ...
      assertThat(finalState.taskState.failure.statusCode, is(400));
      assertThat(finalState.taskState.failure.message, containsString(
          "The agent configuration supplied to host hostAddress was invalid"));
      assertThat(finalState.taskState.failure.message, containsString("No image datastore connected to host"));
    }
