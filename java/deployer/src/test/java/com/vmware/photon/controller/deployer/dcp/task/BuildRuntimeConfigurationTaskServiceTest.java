...
public class BuildRuntimeConfigurationTaskServiceTest {
  ...
  public class EndToEndTest {
    ...
    private void testRuntimeStateFromFile(ContainersConfig.ContainerType containerType,
      ...
      if (containerType == ContainersConfig.ContainerType.Chairman) {
        expectedParameters.put(BuildRuntimeConfigurationTaskService.MUSTACHE_KEY_CHAIRMAN_DEPLOYMENT_ID,
            ServiceUtils.getIDFromDocumentSelfLink(startState.deploymentServiceLink));
      }
