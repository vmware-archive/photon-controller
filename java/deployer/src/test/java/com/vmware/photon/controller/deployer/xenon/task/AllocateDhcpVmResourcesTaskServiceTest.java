...
/**
 * This class implements tests for {@link AllocateDhcpVmResourcesTaskServiceTest} class.
 */
public class AllocateDhcpVmResourcesTaskServiceTest {

  private TestHost host;
  private AllocateDhcpVmResourcesTaskService service;
  ...
  private AllocateDhcpVmResourcesTaskService.State buildValidStartupState() throws Throwable {
    return buildValidStartupState(TaskState.TaskStage.CREATED, null);
  }

  private AllocateDhcpVmResourcesTaskService.State buildValidStartupState(
      TaskState.TaskStage stage,
      AllocateDhcpVmResourcesTaskService.TaskState.SubStage subStage) throws Throwable {
    AllocateDhcpVmResourcesTaskService.State state = ReflectionUtils.buildValidStartState(
        AllocateDhcpVmResourcesTaskService.State.class);
  ...
  private AllocateDhcpVmResourcesTaskService.State buildValidPatchState(
    ...
    AllocateDhcpVmResourcesTaskService.State state = new AllocateDhcpVmResourcesTaskService.State();
    state.taskState = new AllocateDhcpVmResourcesTaskService.TaskState();
    state.taskState.stage = stage;
    state.taskState.subStage = subStage;
    return state;
  }
  ...
  public class InitializationTest {
    ...
    public void setUp() throws Throwable {
      service = new AllocateDhcpVmResourcesTaskService();
    }
  ...
  public class HandleStartTest {
    ...
    public void testMinimalStartState(
      ...
      AllocateDhcpVmResourcesTaskService.State startState = buildValidStartupState(stage, subStage);
      Operation startOp = host.startServiceSynchronously(service, startState);
      assertThat(startOp.getStatusCode(), is(200));

      AllocateDhcpVmResourcesTaskService.State savedState = host.getServiceState(
          AllocateDhcpVmResourcesTaskService.State.class);
    ...
    public Object[][] getValidStartStates() {
      ...
      return new Object[][]{
          ...
          {TaskState.TaskStage.STARTED,
              AllocateDhcpVmResourcesTaskService.TaskState.SubStage.GET_LOAD_BALANCER_ADDRESS},
          {TaskState.TaskStage.STARTED,
              AllocateDhcpVmResourcesTaskService.TaskState.SubStage.UPLOAD_VM_IMAGE},
          {TaskState.TaskStage.STARTED,
              AllocateDhcpVmResourcesTaskService.TaskState.SubStage.CREATE_VM_FLAVOR},
          {TaskState.TaskStage.STARTED,
              AllocateDhcpVmResourcesTaskService.TaskState.SubStage.CREATE_VM_DISK_FLAVOR},
    ...
    public void testMissingStateValue(String attributeName) throws Throwable {
      AllocateDhcpVmResourcesTaskService.State startState = ReflectionUtils.buildValidStartState(
          AllocateDhcpVmResourcesTaskService.State.class);
    ...
    public Object[][] getAttributeNames() {
      List<String> notNullAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          AllocateDhcpVmResourcesTaskService.State.class, NotNull.class);
  ...
  public class HandlePatchTest {
    ...
    public void testValidStageUpdates(
        ...
        AllocateDhcpVmResourcesTaskService.TaskState.SubStage startSubStage,
        TaskState.TaskStage targetStage,
        AllocateDhcpVmResourcesTaskService.TaskState.SubStage targetSubStage)
        throws Throwable {

      AllocateDhcpVmResourcesTaskService.State startState = buildValidStartupState(startStage, startSubStage);
      host.startServiceSynchronously(service, startState);

      AllocateDhcpVmResourcesTaskService.State patchState = buildValidPatchState(targetStage, targetSubStage);
      ...
      AllocateDhcpVmResourcesTaskService.State savedState =
          host.getServiceState(AllocateDhcpVmResourcesTaskService.State.class);
    ...
    public void testInvalidPatchStateValue(String attributeName) throws Throwable {
      AllocateDhcpVmResourcesTaskService.State startState = buildValidStartupState(
          TaskState.TaskStage.CREATED, null);
      Operation startOperation = host.startServiceSynchronously(service, startState);
      assertThat(startOperation.getStatusCode(), is(200));

      AllocateDhcpVmResourcesTaskService.State patchState = buildValidPatchState(
          TaskState.TaskStage.STARTED,
          AllocateDhcpVmResourcesTaskService.TaskState.SubStage.UPLOAD_VM_IMAGE);
    ...
    public Object[][] getAttributeNames() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              AllocateDhcpVmResourcesTaskService.State.class, Immutable.class));
    }
  }
  ...
  public class EndToEndTest {
    ...
    private AllocateDhcpVmResourcesTaskService.State startState;
    ...
    public void testEndToEndSuccess() throws Throwable {
      ...
      AllocateDhcpVmResourcesTaskService.State finalState =
          machine.callServiceAndWaitForState(
              AllocateDhcpVmResourcesTaskFactoryService.SELF_LINK,
              startState,
              AllocateDhcpVmResourcesTaskService.State.class,
