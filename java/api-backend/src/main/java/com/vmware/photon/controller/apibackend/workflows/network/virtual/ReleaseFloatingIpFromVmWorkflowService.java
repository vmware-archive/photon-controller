...
package com.vmware.photon.controller.apibackend.workflows.network.virtual;
...
import com.vmware.photon.controller.apibackend.workflows.BaseWorkflowService;
 ...
 */
public class ReleaseFloatingIpFromVmWorkflowService extends BaseWorkflowService<ReleaseFloatingIpFromVmWorkflowDocument,
    ReleaseFloatingIpFromVmWorkflowDocument.TaskState, ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage> {

  public static final String FACTORY_LINK = ServiceUriPaths.APIBACKEND_ROOT + "/remove-floating-ip";

  public static FactoryService createFactory() {
    return FactoryService.create(ReleaseFloatingIpFromVmWorkflowService.class,
        ReleaseFloatingIpFromVmWorkflowDocument.class);
  }

  public ReleaseFloatingIpFromVmWorkflowService() {
    super(ReleaseFloatingIpFromVmWorkflowDocument.class,
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.class,
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.class);
  }

  @Override
  public void handleCreate(Operation createOperation) {
    ServiceUtils.logInfo(this, "Creating service %s", getSelfLink());
    ReleaseFloatingIpFromVmWorkflowDocument state =
        createOperation.getBody(ReleaseFloatingIpFromVmWorkflowDocument.class);
  ...
  public void handleStart(Operation startOperation) {
    ...
    ReleaseFloatingIpFromVmWorkflowDocument state =
        startOperation.getBody(ReleaseFloatingIpFromVmWorkflowDocument.class);
  ...
  public void handlePatch(Operation patchOperation) {
    ...
    try {
      ReleaseFloatingIpFromVmWorkflowDocument currentState = getState(patchOperation);
      ReleaseFloatingIpFromVmWorkflowDocument patchState =
          patchOperation.getBody(ReleaseFloatingIpFromVmWorkflowDocument.class);
  ...
  private void processPatch(ReleaseFloatingIpFromVmWorkflowDocument state) {
    try {
  ...
  private void getVmMac(ReleaseFloatingIpFromVmWorkflowDocument state) {
    CloudStoreUtils.getAndProcess(
        this,
        ...
        vmState -> {
          try {
            ...
            ReleaseFloatingIpFromVmWorkflowDocument patchState = buildPatch(
                TaskState.TaskStage.STARTED,
                ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.GET_NSX_CONFIGURATION);
  ...
  private void getNsxConfiguration(ReleaseFloatingIpFromVmWorkflowDocument state) {
    CloudStoreUtils.queryAndProcess(
        ...
        deploymentState -> {
          try {
            ReleaseFloatingIpFromVmWorkflowDocument patchState = buildPatch(
                TaskState.TaskStage.STARTED,
                ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.REMOVE_DNAT_RULE);
  ...
  private void removeDnatRule(ReleaseFloatingIpFromVmWorkflowDocument state) throws Throwable {
        ...
        new FutureCallback<Void>() {
          ...
          public void onSuccess(Void result) {
            try {
              ReleaseFloatingIpFromVmWorkflowDocument patchState = buildPatch(
                  TaskState.TaskStage.STARTED,
                  ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.REMOVE_SNAT_RULE);
  ...
  private void removeSnatRule(ReleaseFloatingIpFromVmWorkflowDocument state) throws Throwable {
        ...
        new FutureCallback<Void>() {
          ...
          public void onSuccess(Void result) {
            try {
              ReleaseFloatingIpFromVmWorkflowDocument patchState = buildPatch(
                  TaskState.TaskStage.STARTED,
                  ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.RELEASE_VM_FLOATING_IP);
              patchState.taskServiceEntity = state.taskServiceEntity;
  ...
  private void releaseVmFloatingIp(ReleaseFloatingIpFromVmWorkflowDocument state) {
    ...
    CloudStoreUtils.patchAndProcess(
        ...
        releaseIpResult -> {
          progress(state, ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.RELEASE_QUOTA);
        },
        throwable -> {
          fail(state, throwable);
        }
  ...
  private void releaseQuota(ReleaseFloatingIpFromVmWorkflowDocument state) {
    CloudStoreUtils.getAndProcess(
        this,
        VmServiceFactory.SELF_LINK + "/" + state.vmId,
        VmService.State.class,
        vmState -> {
          ...
          if (!vmNetworkInfo.isFloatingIpQuotaConsumed) {
            ServiceUtils.logInfo(ReleaseFloatingIpFromVmWorkflowService.this,
                "The quota was not consumed. Skip releasing quota.");
            progress(state, ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.UPDATE_VM);
            return;
          }
  ...
  private void releaseQuota(ReleaseFloatingIpFromVmWorkflowDocument state, String projectId) {
    CloudStoreUtils.getAndProcess(
        this,
  ...
  private void returnQuota(ReleaseFloatingIpFromVmWorkflowDocument state, String resourceTicketId) {
  ...
  private void updateVm(ReleaseFloatingIpFromVmWorkflowDocument state) {
    CloudStoreUtils.getAndProcess(
        this,
        VmServiceFactory.SELF_LINK + "/" + state.vmId,
        VmService.State.class,
  ...
  private void updateVm(ReleaseFloatingIpFromVmWorkflowDocument state, VmService.State vmPatchState) {
    CloudStoreUtils.patchAndProcess(
        this,
        VmServiceFactory.SELF_LINK + "/" + state.vmId,
        vmPatchState,
        VmService.State.class,
        vmState -> {
          progress(state, ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.UPDATE_VIRTUAL_NETWORK);
        },
        throwable -> {
          fail(state, throwable);
        }
  ...
  private void updateVirtualNetwork(ReleaseFloatingIpFromVmWorkflowDocument state) {
