...
package com.vmware.photon.controller.apibackend.tasks.network.virtual;
...
import com.vmware.photon.controller.apibackend.servicedocuments.network.virtual.CreateLogicalPortsRoutingTask;
import com.vmware.photon.controller.apibackend.servicedocuments.network.virtual.CreateLogicalPortsRoutingTask.TaskState;
 ...
 */
public class CreateLogicalPortsTaskService extends StatefulService {

  public static final String FACTORY_LINK = ServiceUriPaths.APIBACKEND_ROOT + "/configure-routing-tasks";
  private static final int NUM_RETRIES = 5;

  public static FactoryService createFactory() {
    return FactoryService.create(CreateLogicalPortsTaskService.class, CreateLogicalPortsRoutingTask.class);
  }

  public CreateLogicalPortsTaskService() {
    super(CreateLogicalPortsRoutingTask.class);
  ...
  public void handleStart(Operation startOperation) {
    ...
    try {
      CreateLogicalPortsRoutingTask startState = startOperation.getBody(CreateLogicalPortsRoutingTask.class);
  ...
  public void handlePatch(Operation patchOperation) {
    ...
    try {
      CreateLogicalPortsRoutingTask currentState = getState(patchOperation);
      CreateLogicalPortsRoutingTask patchState = patchOperation.getBody(CreateLogicalPortsRoutingTask.class);
  ...
  private void processPatch(CreateLogicalPortsRoutingTask currentState) {
    try {
  ...
  private void createLogicalSwitchPort(CreateLogicalPortsRoutingTask currentState) throws Throwable {
    ...
    logicalSwitchApi.createLogicalPort(spec,
        new FutureCallback<LogicalPort>() {
          ...
          public void onSuccess(@Nullable LogicalPort result) {
            CreateLogicalPortsRoutingTask patch = buildPatch(TaskState.TaskStage.STARTED,
                TaskState.SubStage.CONNECT_TIER1_ROUTER_TO_SWITCH,
                null);
            patch.logicalSwitchPortId = result.getId();

            TaskUtils.sendSelfPatch(CreateLogicalPortsTaskService.this, patch);
          }
  ...
  private void connectTier1RouterToSwitch(CreateLogicalPortsRoutingTask currentState) throws Throwable {
    ...
    logicalRouterApi.createLogicalRouterDownLinkPort(spec,
        new FutureCallback<LogicalRouterDownLinkPort>() {
          ...
          public void onSuccess(@Nullable LogicalRouterDownLinkPort result) {
            CreateLogicalPortsRoutingTask patch = null;
  ...
  private void createTier0RouterPort(CreateLogicalPortsRoutingTask currentState) throws Throwable {
  ...
  private void connectTier1RouterToTier0Router(CreateLogicalPortsRoutingTask currentState) throws Throwable {
  ...
  private void addSnatRules(CreateLogicalPortsRoutingTask currentState) throws Throwable {
  ...
  private void getRoutingAdvertisement(CreateLogicalPortsRoutingTask currentState, List<Integer> retryCount) {
  ...
  private void enableRoutingAdvertisement(
      CreateLogicalPortsRoutingTask currentState, int revision, List<Integer> retryCount) {
        ...
        nsxClient.getLogicalRouterApi().configureRoutingAdvertisement(
            ...
            new FutureCallback<RoutingAdvertisement>() {
              ...
              public void onSuccess(@Nullable RoutingAdvertisement routingAdvertisement) {
                CreateLogicalPortsRoutingTask patch = buildPatch(TaskState.TaskStage.FINISHED);
                TaskUtils.sendSelfPatch(CreateLogicalPortsTaskService.this, patch);
              }
              ...
              public void onFailure(Throwable t) {
                ...
                if (currNumTries++ < NUM_RETRIES) {
                  ServiceUtils.logSevere(CreateLogicalPortsTaskService.this,
  ...
  private void validateStartState(CreateLogicalPortsRoutingTask state) {
    validateState(state);
  ...
  private void validateState(CreateLogicalPortsRoutingTask state) {
    ValidationUtils.validateState(state);
    ValidationUtils.validateTaskStage(state.taskState);
  }

  private void validatePatchState(
      CreateLogicalPortsRoutingTask currentState, CreateLogicalPortsRoutingTask patchState) {
  ...
  private CreateLogicalPortsRoutingTask buildPatch(TaskState.TaskStage stage) {
    return buildPatch(stage, null, null);
  }

  private CreateLogicalPortsRoutingTask buildPatch(TaskState.TaskStage stage, TaskState.SubStage subStage) {
    return buildPatch(stage, subStage, null);
  }

  private CreateLogicalPortsRoutingTask buildPatch(TaskState.TaskStage stage, Throwable t) {
    return buildPatch(stage, null, t);
  }

  private CreateLogicalPortsRoutingTask buildPatch(
      TaskState.TaskStage stage, TaskState.SubStage subStage, Throwable t) {
    CreateLogicalPortsRoutingTask state = new CreateLogicalPortsRoutingTask();
  ...
  private void failTask(Throwable t) {
    ...
    try {
      CreateLogicalPortsRoutingTask patchState = buildPatch(TaskState.TaskStage.FAILED, t);
