...
public class ConfigRoutingTaskServiceTest {
  ...
  public static class HandleStartTest {
    ...
    @Test
    public void testSuccessfulHandleStart() throws Throwable {
    ...
    @Test(dataProvider = "invalidStartTaskStage")
    public void testInvalidStartTaskStage(TaskState.TaskStage startStage,
                                          TaskState.SubStage startSubStage,
                                          String expectedErrorMessage) throws Throwable {

      try {
        createConfigureRoutingTaskService(host,
            configureRoutingTaskService,
            startStage,
            startSubStage,
            RoutingType.ROUTED,
    ...
    @DataProvider(name = "invalidStartTaskStage")
    private Object[][] getInvalidStartTaskStage() {
      return new Object[][] {
          {TaskState.TaskStage.CREATED, TaskState.SubStage.CREATE_ROUTER_PORT,
              "Task substage must start from CREATE_SWITCH_PORT"},
          {TaskState.TaskStage.CREATED, TaskState.SubStage.CONNECT_TIER0_ROUTER,
              "Task substage must start from CREATE_SWITCH_PORT"},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              "Task stage must start from CREATED"},
          {TaskState.TaskStage.FINISHED, null, "Task stage must start from CREATED"},
          {TaskState.TaskStage.CANCELLED, null, "Task stage must start from CREATED"},
          {TaskState.TaskStage.FAILED, null, "Task stage must start from CREATED"}
      };
    }
  ...
  public static class HandlePatchTest {
    ...
    public Object[][] getValidStageTransition() {
      return new Object[][] {
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_ROUTER_PORT, RoutingType.ROUTED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_ROUTER_PORT, RoutingType.ISOLATED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_ROUTER_PORT,
              TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER0_ROUTER, RoutingType.ROUTED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER0_ROUTER,
    ...
    public Object[][] getInvalidStageTransition() {
      return new Object[][] {
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER0_ROUTER, RoutingType.ISOLATED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER0_ROUTER, RoutingType.ROUTED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT,
              TaskState.TaskStage.FINISHED, null, RoutingType.ROUTED},
    ...
    private void patchTaskToState(String documentSelfLink,
      ...
      Pair<TaskState.TaskStage, TaskState.SubStage>[] transitionSequence = new Pair[]{
          ...
          Pair.of(TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_ROUTER_PORT),
          Pair.of(TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER0_ROUTER),
