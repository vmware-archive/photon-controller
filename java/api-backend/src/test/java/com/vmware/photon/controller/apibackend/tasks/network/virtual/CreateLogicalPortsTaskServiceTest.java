...
/**
 * Tests for {@link com.vmware.photon.controller.apibackend.tasks.network.virtual.CreateLogicalPortsTaskService}.
 */
public class CreateLogicalPortsTaskServiceTest {
  ...
  public static class InitializationTest {
    ...
    public void testCapabilities() {
      ...
      CreateLogicalPortsTaskService service = new CreateLogicalPortsTaskService();
  ...
  public static class HandleStartTest {
    ...
    private static CreateLogicalPortsTaskService configureRoutingTaskService;
    ...
    public void setupTest() {
      configureRoutingTaskService = new CreateLogicalPortsTaskService();
    ...
    public void testSuccessfulHandleStart(TaskState.TaskStage startStage,
      ...
      CreateLogicalPortsRoutingTask createdState = createConfigureRoutingTaskService(host, configureRoutingTaskService,
          startStage, startSubStage, RoutingType.ROUTED, ControlFlags.CONTROL_FLAG_OPERATION_PROCESSING_DISABLED);

      CreateLogicalPortsRoutingTask savedState = host.getServiceState(
          CreateLogicalPortsRoutingTask.class, createdState.documentSelfLink);
    ...
    public void testNotEmptyFields(String fieldName, String expectedErrorMessage) throws Throwable {
      CreateLogicalPortsRoutingTask startState = new CreateLogicalPortsRoutingTask();
  ...
  public static class HandlePatchTest {
    ...
    public void testValidStageTransition(TaskState.TaskStage startStage,
      ...
      CreateLogicalPortsRoutingTask createdState = createConfigureRoutingTaskService(host,
      ...
      CreateLogicalPortsRoutingTask patchState = buildPatchState(targetStage, targetSubStage);
    ...
    public void testChangeImmutableFields(String fieldName) throws Throwable {
      ...
      CreateLogicalPortsRoutingTask patchState = buildPatchState(TaskState.TaskStage.STARTED,
          TaskState.SubStage.CREATE_SWITCH_PORT);
    ...
    public Object[][] getValidStageTransition() {
      return new Object[][] {
          ...
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CONNECT_TIER1_ROUTER_TO_TIER0_ROUTER,
              TaskState.TaskStage.STARTED, TaskState.SubStage.ADD_SNAT_RULES, RoutingType.ROUTED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.ADD_SNAT_RULES,
    ...
    public Object[][] getInvalidStageTransition() {
      return new Object[][] {
          ...
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT, TaskState.TaskStage.STARTED,
              TaskState.SubStage.ADD_SNAT_RULES, RoutingType.ISOLATED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT, TaskState.TaskStage.STARTED,
              TaskState.SubStage.ADD_SNAT_RULES, RoutingType.ROUTED},
          {TaskState.TaskStage.STARTED, TaskState.SubStage.CREATE_SWITCH_PORT, TaskState.TaskStage.STARTED,
    ...
    public Object[][] getImmutableFields() {
      List<String> immutableAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          CreateLogicalPortsRoutingTask.class, Immutable.class);
    ...
    public Object[][] getWriteOnceFields() {
      List<String> immutableAttributes = ReflectionUtils.getAttributeNamesWithAnnotation(
          CreateLogicalPortsRoutingTask.class, WriteOnce.class);
      return TestHelper.toDataProvidersList(immutableAttributes);
    }
    ...
    private void patchTaskToState(String documentSelfLink,
      ...
      Pair<TaskState.TaskStage, TaskState.SubStage>[] transitionSequence = new Pair[]{
          ...
          Pair.of(TaskState.TaskStage.STARTED, TaskState.SubStage.ADD_SNAT_RULES),
      ...
      for (Pair<TaskState.TaskStage, TaskState.SubStage> state : transitionSequence) {
        CreateLogicalPortsRoutingTask patchState = buildPatchState(state.getLeft(), state.getRight());
        ...
        CreateLogicalPortsRoutingTask savedState = host.getServiceState(
            CreateLogicalPortsRoutingTask.class, documentSelfLink);
  ...
  public class EndToEndTest {
    ...
    public void testFailedToCreateSwitchPort() throws Throwable {
      ...
      CreateLogicalPortsRoutingTask savedState = startService(RoutingType.ISOLATED);
    ...
    public void testFailedtoCreateTier0RouterPort() throws Throwable {
      ...
      CreateLogicalPortsRoutingTask savedState = startService(RoutingType.ROUTED);
      assertThat(savedState.taskState.stage, is(TaskState.TaskStage.FAILED));
    }
    ...
    @Test
    public void testFailedToAddSnatRules() throws Throwable {
      NsxClientMock nsxClientMock = new NsxClientMock.Builder()
          .createLogicalPort(true, "logicalPortId")
          .createLogicalRouterDownLinkPort(true, "logicalRouterDownLinkPortId")
          .createLogicalLinkPortOnTier0Router(true, "logicalLinkPortIdOnTier0Router")
          .createLogicalLinkPortOnTier1Router(true, "logicalLinkPortIdOnTier0Router")
          .createNatRule(false, "snatRuleId")
          .build();
      doReturn(nsxClientMock).when(nsxClientFactory).create(any(String.class), any(String.class), any(String.class));
    ...
    private CreateLogicalPortsRoutingTask startService(RoutingType routingType) throws Throwable {
      return testEnvironment.callServiceAndWaitForState(
          CreateLogicalPortsTaskService.FACTORY_LINK,
          buildStartState(TaskState.TaskStage.CREATED, null, routingType, 0),
          CreateLogicalPortsRoutingTask.class,
          (state) -> TaskUtils.finalTaskStages.contains(state.taskState.stage));
    }
  }

  private static CreateLogicalPortsRoutingTask createConfigureRoutingTaskService(
      TestHost testHost,
      CreateLogicalPortsTaskService service,
    ...
    return result.getBody(CreateLogicalPortsRoutingTask.class);
  }

  private static CreateLogicalPortsRoutingTask buildStartState(TaskState.TaskStage startStage,
                                                      TaskState.SubStage subStage,
                                                      RoutingType routingType,
                                                      int controlFlag) {
    ...
    startState.logicalTier1RouterId = UUID.randomUUID().toString();
    startState.snatIp = "192.168.2.1";
    startState.controlFlags = controlFlag;

    return startState;
  }

  private static CreateLogicalPortsRoutingTask buildPatchState(TaskState.TaskStage patchStage,
                                                      TaskState.SubStage patchSubStage) {

    CreateLogicalPortsRoutingTask patchState = new CreateLogicalPortsRoutingTask();
