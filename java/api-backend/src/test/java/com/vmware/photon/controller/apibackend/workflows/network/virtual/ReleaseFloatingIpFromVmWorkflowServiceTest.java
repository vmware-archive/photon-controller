...
/**
 * Tests for
 * {@link com.vmware.photon.controller.apibackend.workflows.network.virtual.ReleaseFloatingIpFromVmWorkflowService}.
 */
public class ReleaseFloatingIpFromVmWorkflowServiceTest {
  private static final TaskStateHelper<ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage> taskStateHelper =
      new TaskStateHelper<>(ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.class);
  ...
  public static class InitializationTest {
    ...
    public void testCapabilities() {
      ...
      ReleaseFloatingIpFromVmWorkflowService service = new ReleaseFloatingIpFromVmWorkflowService();
  ...
  public static class HandleCreateTest {
    ...
    private ReleaseFloatingIpFromVmWorkflowDocument startState;
    ...
    public void setUpTest() throws Throwable {
      ...
      startState = buildStartState(
          ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.CREATED,
          null,
    ...
    public void succeedsWithNullDefaultFields() throws Throwable {
      ...
      ReleaseFloatingIpFromVmWorkflowDocument finalState =
          testEnvironment.callServiceAndWaitForState(
              ReleaseFloatingIpFromVmWorkflowService.FACTORY_LINK,
              startState,
              ReleaseFloatingIpFromVmWorkflowDocument.class,
              (state) -> ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.CREATED == state.taskState.stage);
    ...
    public Object[][] getNotNullFields() {
      return TestHelper.toDataProvidersList(
          ReflectionUtils.getAttributeNamesWithAnnotation(
              ReleaseFloatingIpFromVmWorkflowDocument.class, NotBlank.class));
    }
  }
  ...
  public static class HandleStartTest {
    ...
    public void failsWithInvalidStartState(ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage stage,
                                           ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage subStage)
        throws Throwable {
  ...
  public static class HandlePatchTest {
    ...
    public void succeedsWithValidStageAndSubStagePatch(
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage currentStage,
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage currentSubStage,
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage patchStage,
        ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage patchSubStage) throws Throwable {
      ...
      ReleaseFloatingIpFromVmWorkflowDocument finalState =
          testEnvironment.callServiceAndWaitForState(
              ...
              startState,
              ReleaseFloatingIpFromVmWorkflowDocument.class,
              (state) -> ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.STARTED == state.taskState.stage &&
                  ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.GET_VM_MAC
                      == state.taskState.subStage);

      if (!(currentStage == ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.STARTED &&
          currentSubStage == ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage.GET_VM_MAC)) {
      ...
      finalState = testEnvironment.sendPatchAndWait(finalState.documentSelfLink,
          ...
          .getBody(ReleaseFloatingIpFromVmWorkflowDocument.class);
  ...
  public class EndToEndTest {
    ...
    public void testFailedToRemoveNatRule() throws Throwable {
      ...
      ReleaseFloatingIpFromVmWorkflowDocument savedState = startService();
      assertThat(savedState.taskState.stage, is(ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.FAILED));
    ...
    public void testSuccessfulRemoveFloatingIp() throws Throwable {
      ...
      ReleaseFloatingIpFromVmWorkflowDocument savedState = startService();
      assertThat(savedState.taskState.stage, is(ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage.FINISHED));
    ...
    private ReleaseFloatingIpFromVmWorkflowDocument startService() throws Throwable {
  ...
  private static ReleaseFloatingIpFromVmWorkflowDocument buildStartState(
      ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage startStage,
      ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage subStage,
      String networkId,
      String vmId,
      int controlFlags) {
    ReleaseFloatingIpFromVmWorkflowDocument startState = new ReleaseFloatingIpFromVmWorkflowDocument();
    startState.taskState = new ReleaseFloatingIpFromVmWorkflowDocument.TaskState();
  ...
  private static ReleaseFloatingIpFromVmWorkflowDocument buildPatchState(
      ReleaseFloatingIpFromVmWorkflowDocument.TaskState.TaskStage patchStage,
      ReleaseFloatingIpFromVmWorkflowDocument.TaskState.SubStage patchSubStage) {

    ReleaseFloatingIpFromVmWorkflowDocument patchState = new ReleaseFloatingIpFromVmWorkflowDocument();
    patchState.taskState = new ReleaseFloatingIpFromVmWorkflowDocument.TaskState();
