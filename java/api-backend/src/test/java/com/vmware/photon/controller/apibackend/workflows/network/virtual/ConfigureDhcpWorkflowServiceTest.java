...
import com.vmware.photon.controller.apibackend.servicedocuments.network.virtual.ConfigureDhcpWorkflowDocument;
...
/**
 * Tests for {@link com.vmware.photon.controller.apibackend.workflows.network.virtual.ConfigureDhcpWorkflowService}.
 */
public class ConfigureDhcpWorkflowServiceTest {
  ...
  /**
   * Tests that when
   * {@link com.vmware.photon.controller.apibackend.workflows.network.virtual.ConfigureDhcpWorkflowService#handleCreate}
  ...
  /**
   * Tests that when
   * {@link com.vmware.photon.controller.apibackend.workflows.network.virtual.ConfigureDhcpWorkflowService#handleStart}
   * is called, the workflow will validate the state object and behave correctly.
   */
  ...
  /**
   * Tests that when
   * {@link com.vmware.photon.controller.apibackend.workflows.network.virtual.ConfigureDhcpWorkflowService#handlePatch}
   * is called, the workflow will validate the state object and behave correctly.
   */
