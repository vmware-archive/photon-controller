...
/**
 * This class implements tests for the {@link com.vmware.photon.controller.apibackend.workflows.DeleteVirtualNetworkWorkflowService} class.
 */
public class DeleteVirtualNetworkWorkflowServiceTest {
  ...
  /**
   * Tests that when {@link com.vmware.photon.controller.apibackend.workflows.DeleteVirtualNetworkWorkflowService#handleCreate} is called, the workflow will
  ...
  /**
   * Test that when {@link com.vmware.photon.controller.apibackend.workflows.DeleteVirtualNetworkWorkflowService#handleStart} is called, the workflow will
   * validate the state object and behave correctly.
   */
  ...
  /**
   * Tests that when {@link com.vmware.photon.controller.apibackend.workflows.DeleteVirtualNetworkWorkflowService#handlePatch} is called, the workflow will
   * validate the state object and behave correctly.
   */
  ...
  /**
   * Tests end-to-end scenarios of the {@link com.vmware.photon.controller.apibackend.workflows.DeleteVirtualNetworkWorkflowService}.
   */
