...
package com.vmware.photon.controller.model.adapters.aws;
...
public class FirewallService {
  ...
  public String allocateSecurityGroup(AWSAllocation aws) {
    ...
    try {
      ...
      if (t.getMessage().contains(FirewallService.DEFAULT_SECURITY_GROUP_NAME)) {
  ...
  public SecurityGroup getSecurityGroup(AWSAllocation aws) {
    return getSecurityGroup(aws, FirewallService.DEFAULT_SECURITY_GROUP_NAME);
  }
