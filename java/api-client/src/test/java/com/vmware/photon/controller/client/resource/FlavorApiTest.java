...
public class FlavorApiTest extends ApiTestBase {
  ...
  @Test
  public void testListAllWithQueryParam() throws IOException {
    Flavor flavor1 = new Flavor();
    flavor1.setId("flavor1");
    flavor1.setKind("vm");
    ...
    ResourceList<Flavor> flavorResourceList1 = new ResourceList<>(Arrays.asList(flavor1, flavor3));

    ObjectMapper mapper = new ObjectMapper();
    String serializedResponse = mapper.writeValueAsString(flavorResourceList1);
    ...
    assertTrue(response.getItems().containsAll(flavorResourceList1.getItems()));
  }

  @Test
  public void testListAllWithMultipleQueryParams() throws IOException {
    Flavor flavor1 = new Flavor();
    flavor1.setId("flavor1");
    flavor1.setKind("vm");
    ...
    Map<String, String> params = new HashMap<String, String>();
    params.put("kind", "vm");
    params.put("name", "flavor3");

    ResourceList<Flavor> flavorResourceList = new ResourceList<>(Arrays.asList(flavor3));
