 ...
 */
@Path(ProjectResourceRoutes.PROJECT_SET_SECURITY_GROUPS_PATH)
@Api(value = ProjectResourceRoutes.API)
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class ProjectSecurityGroupsResource {

  private final ProjectFeClient client;

  @Inject
  public ProjectSecurityGroupsResource(ProjectFeClient client) {
    this.client = client;
  }

  @POST
  @ApiOperation(value = "Change the security groups of project", response = Task.class)
