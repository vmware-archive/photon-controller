...
/**
 * TombstoneXenonBackend is responsible for writing the tombstone entries for an object.
 */
public class TombstoneXenonBackend implements TombstoneBackend {

  private static final Logger logger = LoggerFactory.getLogger(TombstoneXenonBackend.class);

  private final ApiFeXenonRestClient xenonClient;

  @Inject
  public TombstoneXenonBackend(ApiFeXenonRestClient xenonClient) {
  ...
  public TombstoneEntity create(String entityKind, String entityId) {
    ...
    Operation result = xenonClient.post(TombstoneServiceFactory.SELF_LINK, state);
  ...
  public void delete(TombstoneEntity tombstone) {
    ...
    xenonClient.delete(TombstoneServiceFactory.SELF_LINK + "/" + tombstone.getId(), new TombstoneService.State());
  ...
  public TombstoneEntity getByEntityId(String id) {
    ...
    List<TombstoneService.State> tombstoneDocs =
        xenonClient.queryDocuments(TombstoneService.State.class, termsBuilder.build());
