...
public class AvailabilityZonesResource {
  ...
  @POST
  @ApiOperation(value = "Create an availability zone", response = Task.class)
  @ApiResponses(value = {
      @ApiResponse(code = 201, message = "Task created, availabilityZone creation progress communicated via the task")
  })
