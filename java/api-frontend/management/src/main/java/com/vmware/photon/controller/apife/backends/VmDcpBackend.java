 ...
 */
public class VmDcpBackend implements VmBackend {
  ...
  public void tombstone(VmEntity vm) throws ExternalException {
    ...
    tombstoneWatch.stop();
    logger.info("VmDcpBackend.tombstone for Vm Id: {} took {} milliseconds",
        vm.getId(),
  ...
  public void tombstoneIsoEntity(IsoEntity isoEntity) {
    // Do nothing here for the dcp implementation
  }
  ...
  private VmEntity create(ProjectEntity project, VmCreateSpec spec) throws ExternalException {
    ...
    createWatch.stop();
    logger.info("VmDcpBackend.create for Vm Id: {} and name: {} took {} milliseconds",
        vmEntity.getId(),
        vm.name,
