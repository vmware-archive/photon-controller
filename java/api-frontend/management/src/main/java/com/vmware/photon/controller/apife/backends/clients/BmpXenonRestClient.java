 ...
 * This class allows for injection of BareMetalProvisionerServerSet and executor specific to API-FE
 */
@Singleton
public class BmpXenonRestClient extends XenonRestClient {

  private static final Logger logger = LoggerFactory.getLogger(BmpXenonRestClient.class);

  @Inject
  public BmpXenonRestClient(@BareMetalProvisionerServerSet ServerSet serverSet,
  ...
  protected void handleTimeoutException(Operation operation, TimeoutException timeoutException) {
    ...
    logger.warn("BmpXenonRestClient.send: TIMEOUT Operation={}, Message={}",
        operation,
  ...
  protected void handleInterruptedException(Operation operation, InterruptedException interruptedException) {
    logger.warn("BmpXenonRestClient.send: INTERRUPTED Operation={}, Exception={}",
        operation,
