...
public class ImageDcpBackend implements ImageBackend {
  ...
  @Override
  public void updateImageDatastore(String imageId, String imageDatastorName) throws ExternalException {
    checkNotNull(imageId);
    checkNotNull(imageDatastorName);
    final ImmutableMap.Builder<String, String> termsBuilder = new ImmutableMap.Builder<>();
    termsBuilder.put("name", imageDatastorName);
