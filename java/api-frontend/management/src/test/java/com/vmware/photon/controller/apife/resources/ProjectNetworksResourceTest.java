...
public class ProjectNetworksResourceTest extends ResourceTest {
  ...
  public void setUpResources() throws Exception {
    ...
    addResource(new ProjectNetworksResource(frontendClient));
  }
  ...
  public void succeedsToCreate() throws Throwable {
    Task task = new Task();
    task.setId(taskId);
    doReturn(task).when(frontendClient).create(eq(projectId), refEq((spec)));
  ...
  public void failsToCreateWithException() throws Throwable {
    when(frontendClient.create(projectId, spec)).thenThrow(new ExternalException("failed"));
