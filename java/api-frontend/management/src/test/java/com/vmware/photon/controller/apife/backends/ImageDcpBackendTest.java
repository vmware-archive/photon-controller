...
public class ImageDcpBackendTest {
  ...
  public static class ImageUpdateTest {
    ...
    public void testUpdateImageDatastore() throws Throwable {
      ...
      DatastoreService.State imageReplicationServiceState = new DatastoreService.State();
      imageReplicationServiceState.name = "image-datastore-name";
      imageReplicationServiceState.id = "image-datastore-id";
