...
public class VmReleaseIpStepCmdTest {
  ...
  public void testSuccess() throws Throwable {
    ...
    verify(photonControllerXenonRestClient, times(2)).patch(eq(IpAllocatorService.FACTORY_LINK),
  ...
  public void testOneMacAddressMissing() throws Throwable {
    ...
    verify(photonControllerXenonRestClient).get(eq(VmServiceFactory.SELF_LINK + "/vm-id"));
    verify(photonControllerXenonRestClient, times(1)).patch(eq(IpAllocatorService.FACTORY_LINK),
        any(IpAllocatorService.IpOperationPatch.class));
  }
