...
/**
 * Tests {@link com.vmware.photon.controller.apife.tasks.DiskTasksResource}.
 */
public class DiskTasksResourceTest extends ResourceTest {
  ...
  @Test
  public void testGetDiskTasksPage() throws Exception {
    task1.setId(taskId1);
    task2.setId(taskId2);
  ...
  private Response getTasks(String pageLink) {
    String uri = diskTaskRoute + "?pageLink=" + pageLink;
