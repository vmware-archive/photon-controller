...
public class SystemResumeStepCmdTest extends PowerMockTestCase {
  ...
  public void setUp() throws Exception {
    step = new StepEntity();
    step.setId("step-1");
    command = spy(new SystemResumeStepCmd(taskCommand, stepBackend, step, serviceConfig));
  }
