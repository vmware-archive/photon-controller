...
/**
 * Test {@link com.vmware.photon.controller.apife.tasks.AvailabilityZoneTasksResource}.
 */
public class AvailabilityZoneTasksResourceTest extends ResourceTest {
  ...
  @Test
  public void testGetAvailabilityZoneTasksPage() throws Exception {
    task1.setId(taskId1);
    task2.setId(taskId2);
  ...
  private Response getTasks(String pageLink) {
    String uri = availabilityZoneTaskRoute + "?pageLink=" + pageLink;
