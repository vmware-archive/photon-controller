...
public class DiskDcpBackendTest {
  ...
  public static class CreateTest extends BaseDaoTest {
    ...
    public void setUp() throws Throwable {
      ...
      diskBackend = new DiskDcpBackend(dcpClient, projectBackend, flavorBackend, resourceTicketBackend,
          taskBackend, entityLockBackend, attachedDiskBackend, tombstoneBackend);
   ...
   */
  @Guice(modules = {HibernateTestModule.class, BackendTestModule.class})
  public static class UpdateTest extends BaseDaoTest {
    private ApiFeDcpRestClient dcpClient;
    private DiskBackend diskBackend;
    ...
    public void setUp() throws Throwable {
      ...
      diskBackend = new DiskDcpBackend(dcpClient, projectBackend, flavorBackend,
          resourceTicketBackend, taskBackend, entityLockBackend, attachedDiskBackend,
          tombstoneBackend);
  ...
  /**
   * Tests for createVmDiskOperationStep.
   */
  @Guice(modules = {HibernateTestModule.class, BackendTestModule.class})
  public static class CreateVmDiskOperationStepTest extends BaseDaoTest {
    ...
    public void setUp() throws Throwable {
      ...
      diskBackend = new DiskDcpBackend(dcpClient, projectBackend, flavorBackend,
          resourceTicketBackend, taskBackend, entityLockBackend,
          attachedDiskBackend, tombstoneBackend);
    ...
    @Test
    public void testCreateVmDiskOperationStep() throws Exception {
      TaskEntity task = diskBackend.prepareDiskCreate(projectId, spec);
      BaseDiskEntity diskEntity = diskBackend.find(PersistentDisk.KIND, task.getEntityId());
      diskBackend.updateState(diskEntity, DiskState.DETACHED);

      diskIds = ImmutableList.of(task.getEntityId());
      taskEntity = taskBackend.createQueuedTask(vm, Operation.ATTACH_DISK);
      diskBackend.createVmDiskOperationStep(taskEntity, vm, diskIds, Operation.ATTACH_DISK);
