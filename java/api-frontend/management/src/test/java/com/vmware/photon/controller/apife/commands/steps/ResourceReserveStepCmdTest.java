...
public class ResourceReserveStepCmdTest extends PowerMockTestCase {
  ...
  public void testCreateNetworkConstraints() throws Throwable {
    ...
    List<String> logicalSwitchIds = (List<String>) connectVmSwitchStep
        .getTransientResource(ResourceReserveStepCmd.LOGICAL_SWITCH_IDS);
    assertThat(logicalSwitchIds, nullValue());
  }
  ...
  public void testCreateVirtualNetworkConstraints() throws Throwable {
    ...
    List<String> logicalSwitchIds = (List<String>) connectVmSwitchStep
        .getTransientResource(ResourceReserveStepCmd.LOGICAL_SWITCH_IDS);
    assertThat(logicalSwitchIds.size(), is(1));
    assertThat(logicalSwitchIds.get(0), is(logicalSwitchId));
  }
