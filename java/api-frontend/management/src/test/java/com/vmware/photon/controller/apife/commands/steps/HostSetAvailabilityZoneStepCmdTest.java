...
public class HostSetAvailabilityZoneStepCmdTest {
  ...
  public void testSuccess() throws InterruptedException, RpcException, ApiFeException {
    ...
    verify(hostClient).provision(hostEntity.getAddress(), agentPort, hostEntity.getAvailabilityZone());
  ...
  public void testRpcException() throws RpcException, InterruptedException, ApiFeException {
    when(hostClient.provision(hostEntity.getAddress(), agentPort, hostEntity.getAvailabilityZone()))
