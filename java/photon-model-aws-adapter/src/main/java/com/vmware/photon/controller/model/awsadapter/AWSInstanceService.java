...
import com.vmware.dcp.common.OperationContext;
...
public class AWSInstanceService extends StatelessService {
    ...
    public static final String SELF_LINK = UriPaths.AWS_INSTANCE_SERVICE;
    ...
    /*
        method will act much like handlePatch, but without persistence as
        this is a stateless service.  Each call to the service will result in a synchronous
        execution of the stages below
            ...
            Consumer<Instance> consumer = new Consumer<Instance>() {
                ...
                public void accept(Instance instance) {
                    ...
                    resultDesc.networkLinks.add(UriUtils.buildUriPath(
                            NetworkInterfaceFactoryService.SELF_LINK, instance.getInstanceId()));
