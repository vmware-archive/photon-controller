...
public class AWSInstanceServiceTest {
    ...
    private static ServiceDocument createAuthCredentialsDocument(
            TestHost host, String privateKey, String privateKeyId) throws Throwable {
     ...
     */
    public abstract class HandleRequestTest extends BaseModelTest {
        ...
        public void testValidation() throws Throwable {
            ...
            host.patchServiceSynchronously(AWSInstanceService.SELF_LINK,req);
