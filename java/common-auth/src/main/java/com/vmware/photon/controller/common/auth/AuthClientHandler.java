...
public class AuthClientHandler {
   ...
   */
  @VisibleForTesting
  protected URI replaceIdTokenWithPlaceholder(URI logoutUri) throws URISyntaxException, UnsupportedEncodingException{
    String placeholderValue = "";
    String keyToMatch = URLDecoder.decode(LOGOUT_URL_ID_TOKEN_START, "UTF-8");
    final String[] queryParams = logoutUri.getQuery().split("&");
