...
if [ ! -n "${PHOTON_CONTROLLER_VERSION}" ]; then
  export PHOTON_CONTROLLER_VERSION=1.1
fi
...
mv kubernetes.ova kubernetes-${KUBERNETES_VERSION}-pc-${PHOTON_CONTROLLER_VERSION}-${BRANCH}-${COMMIT}.ova
