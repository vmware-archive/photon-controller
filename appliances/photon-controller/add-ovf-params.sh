...
sed -i.bak $'s@<VirtualHardwareSection@ <ProductSection ovf:required="false"> \
      ...
      <Property ovf:key="pc_keystore_password" ovf:userConfigurable="true" ovf:type="password"> \
        <Label>Keystore password</Label> \
        <Description>This is the keystore password for storing certs.</Description> \
      </Property> \
      ...
      <Property ovf:key="lw_hostname" ovf:userConfigurable="true" ovf:type="string"> \
        ...
        <Description>Hostname of the Lightwave master.</Description> \
      </Property> \
      ...
      <Property ovf:key="pc_peer_nodes" ovf:userConfigurable="true" ovf:type="string"> \
        ...
        <Description>Comma seperated list of pc nodes.</Description> \
      </Property> \
      <Property ovf:key="pc_syslog_endpoint" ovf:userConfigurable="true" ovf:type="string"> \
        <Label>Syslog endpoint</Label> \
        <Description>Syslog endpoint (optional).</Description> \
      </Property> \
    </ProductSection> \
