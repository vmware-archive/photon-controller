...
describe EsxCloud::ApiClient do
  ...
  it "creates a network" do
    ...
    expect(http_client).to receive(:get).with("/subnets/network-id").and_return(ok_response("subnet"))
  ...
  it "finds network by id" do
    ...
    expect(EsxCloud::Network).to receive(:create_from_json).with("subnet")
                                 .and_return(network)
  ...
  it "finds networks by name" do
    ...
    expect(EsxCloud::NetworkList).to receive(:create_from_json).with("subnets")
                                     .and_return(networks)
  ...
  it "finds all networks" do
    ...
    expect(http_client).to receive(:get).with("/subnets").and_return(ok_response("subnets"))
    expect(EsxCloud::NetworkList).to receive(:create_from_json).with("subnets").and_return(networks)
