...
describe EsxCloud::VirtualNetwork do
  ...
  it "delegates create to client" do
    ...
    expect(EsxCloud::VirtualNetwork.create(create_spec)).to eq virtual_network
  end
  ...
  it "can be created from hash or from JSON" do
    ...
    [from_hash, from_json].each do |virtual_network|
      ...
      virtual_network.lowIpDynamic == "virtual_network_low_ip_dynamic"
      virtual_network.highIpDynamic == "virtual_network_high_ip_dynamic"
      virtual_network.lowIpStatic == "virtual_network_low_ip_static"
      virtual_network.highIpStatic == "virtual_network_high_ip_static"
