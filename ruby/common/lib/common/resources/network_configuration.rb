...
module EsxCloud
  ...
  class NetworkConfiguration
    ...
    attr_reader :virtual_network_enabled, :network_manager_address, :network_manager_username, :network_manager_password, :network_top_router_id
    ...
    def self.create_from_hash(hash)
      ...
      new(hash["virtualNetworkEnabled"], hash["networkManagerAddress"], hash["networkManagerUsername"], hash["networkManagerPassword"], hash["networkTopRouterId"])
    end
    ...
    def initialize(virtual_network_enabled, network_manager_address = nil, network_manager_username = nil,
                   network_manager_password = nil, network_top_router_id = nil)
