...
module EsxCloud
  class DeploymentCreateSpec
    ...
    # @param [NetworkConfigurationCreateSpec] network_configuration
    ...
    def initialize(image_datastores, auth, network_configuration, stats,
      ...
      fail EsxCloud::UnexpectedFormat, "network configuration is class #{network_configuration.class} instead of
NetworkConfigurationCreateSpec" unless network_configuration.is_a?(NetworkConfigurationCreateSpec)
      @image_datastores = image_datastores
      @auth = auth
      @network_configuraiton = network_configuration
      @stats = stats
    ...
    def to_hash
      {
        ...
        auth: @auth.to_hash,
        network_configuration: @network_configuraiton.to_hash,
        stats: @stats.to_hash,
    ...
    def ==(other)
        ...
        @auth == other.auth &&
        @network_configuraiton == other.network_configuration &&
        @stats == other.stats &&
