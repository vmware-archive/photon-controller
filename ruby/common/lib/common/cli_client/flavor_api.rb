  ...
  class CliClient
    module FlavorApi
      ...
      def find_flavor_by_id(id)
        # TODO: call run_cli and parse CLI output to get Flavor object
        @api_client.find_flavor_by_id(id)
      end

      # @return [FlavorList]
      def find_all_flavors()
        # TODO: call run_cli and parse CLI output to get FlavorList object
      ...
      def delete_flavor(id)
        # No CLI command to delete flavor through id, so call api_client directly
