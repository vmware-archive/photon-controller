  ...
  class ApiRoutesHelper
    ...
    def self.vms_routes(id = SecureRandom.uuid)
      [
        ...
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/start", 400, 400, 400, 400, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/stop", 400, 400, 400, 400, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/restart", 400, 400, 400, 400, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/suspend", 400, 400, 400, 400, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/resume", 400, 400, 400, 400, 403),
