  ...
  class ApiRoutesHelper
    ...
    def self.vms_routes(id = SecureRandom.uuid)
      [
        ...
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/start", 404, 404, 404, 404, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/stop", 404, 404, 404, 404, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/restart", 404, 404, 404, 404, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/suspend", 404, 404, 404, 404, 403),
        EsxCloud::ApiRoute.new(:post, "/vms/#{id}/resume", 404, 404, 404, 404, 403),
