...
describe "Harbor-Kube cluster-service lifecycle", cluster: true do
  ...
  it 'should create/delete Harbor cluster successfully' do
    ...
    begin
      ...
      kube_props = EsxCloud::ClusterHelper.construct_kube_properties(kubernetes_master_ip, kubernetes_etcd_ip)
  ...
  # TODO: Use environment variable for harbor admin password
  ...
  def create_kubernetes_application(ssh)
    ...
    puts "Sleeping for 2 mins to let the pod come up ."
    sleep(120)
