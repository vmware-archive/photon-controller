...
class DirectClient(object):
    ...
    def connect(self):
        ...
        if os.path.isfile(cert_file_non_auth) or not self._validate:
            ...
            sock = TSSLSocket.TSSLSocket(host=self._host, port=self._port, validate=False, certfile=cert_file_non_auth,
                                         ca_certs=os.path.dirname(cert_file_non_auth) + "/host.crt",
                                         keyfile=os.path.dirname(cert_file_non_auth) + "/host.key")
            ...
            sock = TSSLSocket.TSSLSocket(host=self._host, port=self._port, certfile=cert_file,
                                         ca_certs=os.path.dirname(cert_file) + "/host.crt",
                                         keyfile=os.path.dirname(cert_file) + "/host.key")
