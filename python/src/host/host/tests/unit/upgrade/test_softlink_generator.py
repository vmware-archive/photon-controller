...
class TestSoftLinkGenerator(unittest.TestCase):
    ...
    def test_new_image_path_symlink_generator_single(self, _walk, _symlink, _isfile, _isdir, _islink):
  ...
  ("/vmfs/volume/ds/images/99/99918002-e58a-11e5-8448-34363bc428a2", [], ["99918002-e58a-11e5-8448-34363bc428a2.vmdk"]),
  ("/vmfs/volume/ds/images/b0", ["b0c15cc5-e705-11e5-b750-34363bc428a2"], []),
  ("/vmfs/volume/ds/images/b0/b0c15cc5-e705-11e5-b750-34363bc428a2", [], ["b0c15cc5-e705-11e5-b750-34363bc428a2.vmdk"])
    ])
    def test_new_image_path_symlink_generator_multiple(self,  _walk, _symlink,  _isfile, _isdir, _islink):
        self.soft_link_generator._create_symlinks_to_new_image_path("/vmfs/volume/ds/images", "ds")
  ...
  ("/vmfs/volume/ds/images/b0/b0c15cc5-e705-11e5-b750-34363bc428a2", [], ["b0c15cc5-e705-11e5-b750-34363bc428a2.vmdk"])
    ...
    def test_new_image_path_symlink_generator_link_present(self,  _walk, _symlink,  _isfile, _isdir, _islink):
        self.soft_link_generator._create_symlinks_to_new_image_path("/vmfs/volume/ds/images", "ds")
  ...
  ("/vmfs/volume/ds/images/b0/b0c15cc5-e705-11e5-b750-34363bc428a2", [], ["b0c15cc5-e705-11e5-b750-34363bc428a2.vmdk"])
    ...
    def test_new_image_path_symlink_generator_dir_present(self,  _walk, _symlink,  _isfile, _isdir, _islink):
        self.soft_link_generator._create_symlinks_to_new_image_path("/vmfs/volume/ds/images", "ds")
        _islink.assert_any_call('/vmfs/volumes/ds/image_99918002-e58a-11e5-8448-34363bc428a2')
        _islink.assert_any_call('/vmfs/volumes/ds/image_b0c15cc5-e705-11e5-b750-34363bc428a2')
        _isdir.assert_any_call('/vmfs/volumes/ds/image_99918002-e58a-11e5-8448-34363bc428a2')
        _isdir.assert_any_call('/vmfs/volumes/ds/image_b0c15cc5-e705-11e5-b750-34363bc428a2')
        _symlink.assert_not_called()
  ...
  ("/vmfs/volume/ds/images/b0/b0c15cc5-e705-11e5-b750-34363bc428a2", [], ["b0c15cc5-e705-11e5-b750-34363bc428a2"])
    ...
    def test_new_image_path_symlink_generator_no_vmdk_present(self, _walk, _symlink,  _isfile, _isdir, _islink):
        self.soft_link_generator._create_symlinks_to_new_image_path("/vmfs/volume/ds/images", "ds")
        self.assertEqual(_symlink.call_count, 1)
        self.assertEqual(_symlink.call_args_list[0][0],
                         ('/vmfs/volume/ds/images/99/99918002-e58a-11e5-8448-34363bc428a2',
