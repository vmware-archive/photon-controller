...
class EsxVmManager(VmManager):
    ...
    def power_on_vm(self, vm_id):
        self.vim_client.power_on_vm(self, vm_id)

    def power_off_vm(self, vm_id):
        self.vim_client.power_off_vm(self, vm_id)

    def reset_vm(self, vm_id):
        self.vim_client.reset_vm(self, vm_id)

    def suspend_vm(self, vm_id):
        self.vim_client.suspend_vm(self, vm_id)

    def resume_vm(self, vm_id):
        self.vim_client.resume_vm(self, vm_id)
    ...
    def add_disk(self, cspec, datastore, disk_id, info, disk_is_image=False):
        ...
        :type disk_id: str
        """
        return self.vim_client.add_disk(cspec, datastore, disk_id, info, disk_is_image=False)
