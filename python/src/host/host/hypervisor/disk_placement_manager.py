...
class BaseDiskPlacementEngine(DiskPlaceEngine):
    ...
    def placeable_datastores(self):
        ...
        available_image_datastores = self.datastore_manager.image_datastores()
    ...
    def get_datastore_constraint(self, disk):
        ...
        self._logger.info("Found datastores that satisfy tags: %s" %
                          datastores_with_tags)
        ...
        if datastores:
            ...
            if datastore_tags:
                ...
                raise Exception("Missing both DATASTORE and DATASTORETAG "
                                "constraints")
