...
class AgentConfig(object):
    ...
    def update_config(self, provision_req):
        ...
        if self.cpu_overcommit != provision_req.cpu_overcommit:
            ...
            self._trigger_callbacks("cpu_overcommit",
