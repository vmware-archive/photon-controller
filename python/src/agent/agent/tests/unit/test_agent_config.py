...
class TestUnitAgent(unittest.TestCase):
    ...
    def test_config_change(self):
        ...
        self.agent.on_config_change(self.agent.callback_type.CHAIRMAN,
                                    chairman_callback1)
        self.agent.on_config_change(self.agent.callback_type.CHAIRMAN,
                                    chairman_callback2)
        ...
        self.agent.on_config_change(self.agent.callback_type.CPU_OVERCOMMIT,
                                    cpu_callback)
        self.agent.on_config_change(self.agent.callback_type.MEMORY_OVERCOMMIT,
                                    mem_callback)
        self.agent.update_config(provision)
