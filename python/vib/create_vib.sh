...
chmod a+w $SRC_VIB_LAYOUT/payloads/agent/etc/opt/vmware/photon/controller/rui.pem
chmod +t $SRC_VIB_LAYOUT/payloads/agent/etc/opt/vmware/photon/controller/rui.pem
